...
@WorkflowAction(name = "contractChargeNocarEndAction", description = "流程结束动作", workflowName = "合同变更流程非车业务")
@Component(value = "contractChargeNocarEndAction")
public class ContractChargeNocarEndAction implements JbpmBaseAction {
