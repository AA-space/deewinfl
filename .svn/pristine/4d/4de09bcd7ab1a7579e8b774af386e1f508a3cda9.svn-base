 ...
 * Tenwa
 */
@WorkflowAction(name = "noCarConsiderEndAction", description = "流程结束动作", workflowName = "设备复议流程")
@Component(value = "noCarConsiderEndAction")
public class NoCarConsiderEndAction implements JbpmBaseAction{
