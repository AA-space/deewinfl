...
public class WSWSVoucherSrvProxyServiceLocator extends org.apache.axis.client.Service implements com.ormrpc.services.WSWSVoucher.WSWSVoucherSrvProxyService {
    ...
    private java.lang.String WSWSVoucher_address = "http://192.168.1.98:6888/ormrpc/services/WSWSVoucher";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://192.168.1.98:6888/ormrpc/services/WSWSVoucher", "WSWSVoucherSrvProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://192.168.1.98:6888/ormrpc/services/WSWSVoucher", "WSWSVoucher"));
        }
