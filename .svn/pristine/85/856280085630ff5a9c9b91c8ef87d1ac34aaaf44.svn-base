...
@WorkflowAction(name = "riskEarlyWarningStratAction", description = "流程开始动作", workflowName = "风险预警流程")
@Component(value = "riskEarlyWarningStratAction")
public class RiskEarlyWarningStratAction implements JbpmBaseAction {
