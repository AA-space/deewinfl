	...
	<script type="text/javascript">
	   ...
	   function getSelectedPicture(picSrc)
	   {
	    ...
	    function showIconPictureWindow(e)
	    {
	    	...
	    	jQuery("#id_pictureContainer").dialog({
	    	...
	    	jQuery("#id_pictureContainer").dialog("open");
	    }
	</script>
<script type="text/javascript">
	...
	jQuery(function(){
		if(!isWorkflowOper)
		{
		    document.getElementById('id_'+constantFlag.toLowerCase()+'Icon').onclick=function(e){
		    	...
		    	showIconPictureWindow(getEvent(e));
			};
...
<body>
	<div id='menu_main_content' style="float:left;width:325px;overflow:hidden;border:1px solid #DDD;border-top:0px;border-right:0px;padding:5px;">
	   <div class="panel-title" >${currentLabel}列表</div>
	...
	<div id='menu_main_oper' style="overflow:hidden;float:left;border-bottom:1px solid #DDD;padding:5px;">
	   <div class="panel-title" ><font color="red" class="flagUserSelectContainer"></font>&nbsp;&nbsp;部门-角色-人员&nbsp;分配</div>
	...
	<div id='menu_main_oper_right' style="overflow:hidden;float:left;border:1px solid #DDD;border-left:0px;border-top:0px;padding:5px;">
	   <div class="panel-title" ><font color="red" class="flagUserSelectContainer"></font>&nbsp;&nbsp;群组&nbsp;分配</div>
	...
	<div id="id_menuDetailInfoWindowContianer"  buttons="#id-dlg-buttons-menu" closed="true" modal="true" title="菜单信息管理" style="display:none;width:400px;padding-top:10px;height:360px;">
	        <center>
			  <form id="id_menuDetailInfoForm">
			        <table style="width:90%;">
			            ...
			            <tr style="display:none;"><td class="input_label_desc">菜单打开图标: </td><td  colspan=2 class="input_value"><input  type="text" name="iconClose" id="id_menuOpen" readOnly /><span class="content-required">&nbsp;&nbsp;</span></td></tr>
			            <tr style="display:none;"><td class="input_label_desc">菜单关闭图标: </td><td  colspan=2 class="input_value"><input  type="text" name="iconOpen" id="id_menuClose" readOnly/><span class="content-required">&nbsp;&nbsp;</span></td></tr>
