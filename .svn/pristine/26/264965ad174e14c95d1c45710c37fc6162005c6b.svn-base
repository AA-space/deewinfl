...
<script type="text/javascript">
	...
	function formPageReadOnlyCallBack(){  
		if(!isCompletedTask){
			...
			formJSPInputHideOrShow("cont_base_info","contract_equip.contractid,contract_info.projectdept",1);
		}
	}
	//是否保存   
	...
	{
		fillHiddenVal();
		var submitProcessedForm1 = document.getElementById("id_table_leasing_contract_over_info_container");
		var submitProcessedForm2 = document.getElementById("id_table_leasing_contract_change_compoment_container");
		var submitProcessedForm3 = document.getElementById("id_table_leasing_contract_over_com_container");
		...
		if(!Validator.Validate(submitProcessedForm3,1,false)){return false;}
		return true;
	}
	isSubTable = true;
</script>
		...
		<div title="合同结束信息">
			<div id="id_table_leasing_contract_over_info_container" style="overflow: hidden;">
			 <script language="javascript">
			  ...
			  <jsp:include page="contract_over.jsp"></jsp:include>
			<script language="javascript">
