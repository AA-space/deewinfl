...
<input type="hidden" id="id_json_contract_fund_receive_history_str" name="json_contract_fund_receive_history_str" value='${empty json_contract_fund_receive_history_str ? "[]" : json_contract_fund_receive_history_str }'/> 
...
<div class="fillTableContainer">
   <table class="fillTable" cellspacing="0" cellpadding="0">
	...
	<tr class="tr-contract-business-condition" style="width: auto;">
					...
					<div id="id_table_leasing_contract_sign_container"	style="overflow: hidden;">
						<table cellspacing="0" cellpadding="0" style="width: 98%; margin-top: 20px;" >
							 <tr  class="tr-contractect-other-info tr-even">
							    <td class="td-content-title">撤销时间：</td><td class="td-content"><input class="Wdate td-content-input" readonly name="contract_info.repealdate" class="td-content-input"  type="text" value="${requestScope['contract_info.repealdate']}" onClick="WdatePicker(this,{readOnly:true,dateFmt:'yyyy-MM-dd'})" require="true" label="撤销时间"><font class="required-content">*</font></td>
							...
							<tr  class="tr-contractect-other-info tr-even">
							    <td class="td-content-title">撤销原因：</td><td class="td-content" colspan="3"><div class="leftComboContainer" style="width: 90%;"><textarea rows="6"  style="width: 95%;" name="contract_info.repealreason" require="true" label="撤销原因">${requestScope['contract_info.repealreason']}</textarea></div><font class="required-content">*</font></td>
							</tr>
						</table>
					</div>
				</div>
