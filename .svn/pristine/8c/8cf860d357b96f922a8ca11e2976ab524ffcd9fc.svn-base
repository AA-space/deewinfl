...
<body>
    ...
    <div class="mini-toolbar miniext-toolbar-top">
        <table class="miniext-form-fit">
            <tr>
	            <td>
	                <a class="mini-button" iconCls="icon-addfolder" plain="true" onclick="createworkflow">合同审批</a>
    ...
    <div class="mini-fit" id="_fit">
        ...
        <div id="custinfo" class="mini-datagrid" style="width:100%;height:100%;" 
            url="<%=prefix %>/eleasing/workflow/proj_list_info/proj_recredit_info_list.xml"  idField="id"
            sizeList="[5,10,20,50]"
    ...
    <script type="text/javascript">
        ...
        function createworkflow() {
        	...
        	if(row){
        		...
        		startProcess("合同审批流程非车业务-1",attachmentParams); 
        	}else{
        		mini.alert("请选中审批流程的项目！！！");
        	}
