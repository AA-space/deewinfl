...
<body>
    ...
    <div class="mini-toolbar miniext-toolbar-top">
        <table class="miniext-form-fit">
            <tr>
	            <td>
	                <a class="mini-button" iconCls="icon-addfolder" plain="true" onclick="createworkflow">项目撤销</a>
    ...
    <div class="mini-fit" id="_fit">
        ...
        <div id="custinfo" class="mini-datagrid" style="width:100%;height:100%;" 
            url="<%=prefix %>/eleasing/workflow/proj_list_info/proj_cancel_info_list.xml"  idField="id"
            sizeList="[5,10,20,50]"
    ...
    <script type="text/javascript">
        ...
        function createworkflow() {
        	...
        	if(row){
        		...
        		startProcess("项目撤销非车业务-1",attachmentParams); 
        	}else{
        		mini.alert("请选中撤销的项目！！！");
        	}
