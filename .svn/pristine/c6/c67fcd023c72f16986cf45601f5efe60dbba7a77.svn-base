...
<body>
	...
	<div id="mianbody" style="border-style: solid; margin: 0 10px 10px 10px; border-color: #DDDDDD; border-width: 2px; width: 800px; height: 600px; text-align: center">
			...
			<center>
			        <table style="width:95%" class="fillTable">
			            ...
			            <tr  class="tr-even">
			            	...
			            	<td class="td-content">
			            		<span name="dealername" id="dealername" value="${param.dealername}"/>
			            	</td>
			            </tr>
			            <tr class="tr-odd">
		            ...
		            <table>
		            <tr><td><div id="id_table_leasing_compare_temp_list"></div></td></tr>
		            </table>
	        </center>
