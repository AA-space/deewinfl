...
<body>
    <div id="projEquipForm1" class="mini-toolbar miniext-toolbar-top">
        <table class="miniext-form-fit">
            <tr>
	            <td>
	            	<a class="mini-button" iconCls="icon-undo" plain="true" onclick="">租金测算</a>
	                <span class="separator"></span>
	                <a class="mini-button" iconCls="icon-redo" plain="true" onclick="">租金调整</a>
	                <span class="separator"></span>
	                <a class="mini-button" iconCls="icon-addfolder" plain="true" onclick="addRow">增加</a>
	                <span class="separator"></span>
	                <a class="mini-button" iconCls="icon-remove" plain="true" onclick="removeRow">删除</a>
	                <span class="separator"></span>
	                <a class="mini-button" iconCls="icon-save" plain="true" onclick="addRow">保存</a>
	            </td>
            </tr>
        </table>
    </div>
    ...
    <div class="mini-fit" id="_fit">
        ...
        >
            <div property="columns">
                ...
                <div field="equipname" vtype="required"  width="150" headerAlign="center">期项
                	<input property="editor" class="mini-textbox" style="width:100%;" minWidth="150" />
                </div>                            
                <div field="model" width="150" renderer="onGenderRenderer" align="center" headerAlign="center">计划日期
                	<input property="editor" class="mini-datepicker" style="width:100%;" minWidth="150" />
                </div>
                <div  field="equipnum" width="100"  align="center" headerAlign="center">租金
                	<input property="editor" class="mini-textbox" style="width:100%;" minWidth="150" />
                </div>
                
                <div field="price" width="120" headerAlign="center">财务本金
                	<input property="editor" class="mini-textbox" style="width:100%;" minWidth="120" />
                </div>
                <div field="total" width="120" headerAlign="center">财务利息
                	<input property="editor" class="mini-textbox" style="width:100%;" minWidth="120" />
                </div>
    		    <div field="brand" width="200" headerAlign="center">业务本金
                ...
                <div field="brand" width="200" headerAlign="center">租金调整
    		    	<input property="editor" class="mini-textarea" style="width:200px;" minWidth="200" minHeight="50"/>
    		    </div>
            </div>
        </div> 
