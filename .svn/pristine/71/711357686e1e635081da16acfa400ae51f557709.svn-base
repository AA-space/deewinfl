...
<tr>
	...
	<tr>
        <td class="x-panel-table-div-title" colspan=4><div class="toggle-icon-expanded" title="折叠" toggleClass="tr_project_info"></div>保证金收款</td>
    </tr>
	...
	<tr>
        <td class="x-panel-table-div-title" colspan=4><div class="toggle-icon-expanded" title="折叠" toggleClass="tr_project_info"></div>租金计划</td>
    </tr>
	<tr class="tr_project_info">
