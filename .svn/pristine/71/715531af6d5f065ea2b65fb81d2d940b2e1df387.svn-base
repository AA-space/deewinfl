 ...
 * Tenwa
 */
@WorkflowAction(name = "noCarChangeStartAction", description = "流程开始动作", workflowName = "设备变更流程")
@Component(value = "noCarChangeStartAction")
public class NoCarChangeStartAction implements JbpmBaseAction{
...
//				logger.debug("projOtherInfo对象为空");
