<%@ page language="java" contentType="text/html; charset=UTF-8"  pageEncoding="UTF-8" import="com.kernal.utils.EnumUtil" %>
	...
	<script type="text/javascript">
		...
		jQuery(function(){
			...
			seajs.use('js/report/reportconfig',function(rc){
				rc.initPage(comboboxDatas,'${param.reportMenuRoot}');
...
<body>
	...
	<div style="width:100%;height:100%">
		<div id="report_tree_container" class="container mini-panel" title="<s:message code='report.config.form.report' text='报表'/>">		
			<div id="report_tree"></div>
		</div>
		<div id="content_tree_container" class='container mini-panel' title="<s:message code='report.config.form.content' text='图表'/>">		
			<div id="table_chart_tree"></div>
		</div>
		<!--表格表单-->
		<div id="table_container" style="margin-top:5px;display:none" class="container mini-panel" width="800px" title="<s:message code='report.config.form.table' text='表格' />">
			<div id="table_toolbar" style="display:none">
				<a class="panel-button" id="btn_save_table" href="javascript:void(0);"><span class="mini-button-text mini-button-icon icon-save">保存</span></a>	
			</div>
			<jsp:include page="Form_Table_Config.jsp" flush="true"></jsp:include>
		</div>
		<!--静态页面表单-->		
		<div id="page_container" style="margin-top:5px;display:none" class="container mini-panel" width="800px" title="<s:message code='report.config.form.page' text='静态页' />">
			<div id="page_toolbar" style="display:none">
				<a class="panel-button" id="btn_save_page" href="javascript:void(0);"><span class="mini-button-text mini-button-icon icon-save">保存</span></a>	
			</div>
			<jsp:include page="Form_Page_Config.jsp" flush="true"></jsp:include>
		</div>
		<!--图形表单-->
		<div id="chart_container" style="margin-top:5px;display:none" class="container mini-panel" width="800px" title="<s:message code='report.config.form.chart' text='图表' />">
			<div id="chart_toolbar" style="display:none">
				<a class="panel-button" id="btn_save_chart" href="javascript:void(0)"><span class="mini-button-text mini-button-icon icon-save">保存</span></a>
			</div>
	...
	<div id="report_contextmenu" class="mini-contextmenu" style="display:none;width:120px;">
		<div id="report_contextmenu_add_folder" iconCls="icon-plus-w">添加文件夹</div>
		<div id="report_contextmenu_add_report" iconCls="icon-plus-w">添加报表</div>		
		<div id="report_contextmenu_modify" iconCls="icon-cogs-w" >修改</div>
		<div id="report_contextmenu_export" iconCls="icon-cogs-w">导出</div>
		<div id="report_contextmenu_import" iconCls="icon-cogs-w">导入</div>
		<div id="report_contextmenu_delete" iconCls="icon-minus-w">删除</div>
	</div>

	<div id="content_contextmenu" class="mini-contextmenu" style="display:none;width:120px;">
		<div id="content_contexmenu_add_table" iconCls="icon-plus-w">添加表格报表</div>
		<div id="content_contextmenu_add_chart" iconCls='icon-plus-w'>添加图形报表</div>
		<div id="content_contextmenu_add_page" iconCls="icon-plus-w">添加静态页面</div>	
		<div id="content_contextmenu_delete" iconCls="icon-plus-w">删除</div>
	</div>
	...
	<div id="div_upload" class="mini-window" modal="true" title="报表导入" style="width:450px">
		...
		<table style="width:98%;padding-left:20px;padding-top:15px;">
			...
			<tr>
				<td style="text-align:right;padding-right:10px">
					<a id="import_ok" class="mini-button"><span>确定</span></a>
					<a id="import_cancel" class="mini-button"><span>关闭</span></a>
				</td>
			</tr>
		</table>
