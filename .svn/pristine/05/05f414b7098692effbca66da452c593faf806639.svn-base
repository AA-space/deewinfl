...
<input type="hidden" id="id_json_proj_guaranty_detail_str" 	name="json_proj_guaranty_detail_str" value='${empty json_proj_guaranty_detail_str ? "[]" : json_proj_guaranty_detail_str }'></input>
	...
	<div class="fillTableContainer">
		<table class="fillTable" cellspacing="0" cellpadding="0">
			<tr>
				<td colspan=4>
					<!-- 插入项目基本信息 --> <jsp:include page="proj_base_info.jsp"></jsp:include>
				</td>
			</tr>
			<tr>
				<td colspan=4>
					<div class="mini-panel" title="租赁物件" showCollapseButton="true" style="width: 99%;">
					  <div id="tabDeatils" class="mini-tabs" activeIndex="0"
						style="width: 100%; height:auto" bodyStyle="padding:0;border:0;">
