...
<div id="datasource" class="mini-window" modal="true" title="数据源配置" >
	<div id="datasourceForm" class="mini-form" style="margin:20px;margin-top:5px;margin-bottom:-5px">
		<table>
			<tr>
				<td class="input_label_desc">名称:</td>
				<td><input id="dataSourceName" name="dataSourceName" class="mini-textbox" value="" required="true"/></td>
			</tr>
			<tr>
