...
<table class="fillTable" cellspacing="0" cellpadding="0" width="50%" id="id_contract_condition_cash_deposit_content" >
	...
	<td class="td-content"><input class="td-content-input" type="text" name="projcondition_info.deductible" id="projcondition_info.deductible" value="${empty requestScope['projcondition_info.deductible']?'0':requestScope['projcondition_info.deductible']}"/></td>
	<td></td>
	<td><input type="button"  value="自动核销" onclick="autoHX()"></input></td>
	</tr>
