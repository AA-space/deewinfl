<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	var table_fund_rent_inComes = new tracywindyMultiTable({
	    ...
	    columns:[
	       ...
	       {name:'rawValue_balancemode',  header:'结算方式',nullable:false,readOnly:true,type:'combobox',hiddenName:'balancemode',
	    	   config:{
			       width:165,
	       ...
	       {name:'interestadjust',  header:'租息调整',hidden:true, nullable:false,type:'double', otherAttributes:'id="re_interestadjust" onkeyup="comptuerCurMoney()"'},
	       {name:'penaltyadjust',  header:'罚息调整',hidden:true, nullable:false,type:'double', otherAttributes:'id="re_penaltyadjust" onkeyup="comptuerCurMoney()"'},
