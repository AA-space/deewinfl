...
jQuery(function(){
	...
	var creditId = new tracywindyComboBox({
	    ...
	    xmlFileName:'\\eleasing\\jsp\\financing_config\\finacing_config_creditChange.xml',
	    loadMode:'ajax',
	    readOnly:true,
		isContainEmpty:false,
	...
	function openWindow(){
		...
		if(!crediter) {
			...
			return false;
			   ...
			   var attachmentParams="financing_credit.crediter="+crediter+"&financing_credit.credit_id="+creditId;
		       startProcess("授信变更流程-1",attachmentParams);
	    }
	}
</script>
</head>
...
<table align="center">
	...
	<tr>
		...
		<div id="id_crediter"></div>
		</td>
	</tr>
	<tr>
		<td class="input_label_desc">授信标号:</td>
		<td class="input_value">
		<div id="id_creditId"></div>
		</td>
	</tr>
