...
jQuery(function(){
	    ...
	    columns:[
	       ...
	       {name:'accountbank',  header:'本方银行',nullable:false,defaultValue:"浦发银行南市支行"}, 
	       {name:'account',  header:'本方银行账户',nullable:false,defaultValue:"德银上海浦发基本户(6353)"},
	       {name:'accnumber',  header:'本方银行账号(必填凭证字账号)',nullable:false,defaultValue:"98250154740006353"},
	       /* {name:'accnumbername',  header:'本方银行账号'
	    	   ,type:'combobox',hiddenName:'accnumber',nullable:false,
	    	   config:{
		       width:165,
