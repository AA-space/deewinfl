...
<table style="width: 100%;border: 1px #DDD solid;" class="fillTable" >
	    ...
	    <tr class="tr-odd">
           	...
           	<td class="td-content" align="left">
           		<input name="senddate" id="senddate"  class="Wdate td-content-input td-content-readonly"  onClick="WdatePicker(this,{readOnly:true})" require="true"  label="新闻时间"   type="text" /><font class="required-content">*</font>
           	</td>
	    </tr>
		<tr class="tr-even">
	...
	jQuery(function(){
	    ...
	    var table = new tracywindyOperationTable({
	         ...
	         columns:[
		            ...
		            {header:'主题',name:'msgtitle',queryConfig:{},renderer:function(value,tableObj,columnName,columnIndex,rowData){
			           return "<a href='javascript:void(0);' onclick=\"preview("+rowData.rowIndex+")\">"+value+"</a>";       
			        }},
		            {header:'发布时间',name:'senddate',type:'date',queryConfig:{}},
