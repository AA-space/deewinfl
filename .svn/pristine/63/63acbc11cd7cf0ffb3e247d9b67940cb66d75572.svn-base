 ...
 * @Copyright Tenwa
 */
@WorkflowAction(name = "projChangeStartAction", description = "流程开始动作", workflowName = "立项变更流程")
...
public class ProjChangeStartAction implements JbpmBaseAction {
	...
	public void start(HttpServletRequest request, Map<String, String> variablesMap, JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		...
		} // variablesMap.put("proj_info.industrytype",
			// custInfo.getCustClass().getCode().equals("CUST_INFO_COMPANY")?custInfo.getCustInfoCompany().getCustKind().getCode():custInfo.getCustInfoPerson().getCustKind().getCode());
		/** 判断选的是法人还是自然人 */
	...
	public String delete(HttpServletRequest request, Map<String, String> variablesMap, JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		...
		String proj_id = variablesMap.get("proj_id");// 先获得proj_id
		ProjInfo projInfo = (ProjInfo) this.tableService.findEntityByID(ProjInfo.class, proj_id);
		projInfo.setWorkFlag(AppStaticUtil.WORKFLOW_OFF);// 更新状态为流程 为空闲状态
		return null;
	}
