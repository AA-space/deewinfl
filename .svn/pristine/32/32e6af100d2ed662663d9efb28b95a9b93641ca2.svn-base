...
@WorkflowAction(name = "contractBrrowStartAction", description = "流程开始动作", workflowName = "合同借阅")
@Component(value = "contractBrrowStartAction")
public class ContractBrrowStartAction implements JbpmBaseAction {
