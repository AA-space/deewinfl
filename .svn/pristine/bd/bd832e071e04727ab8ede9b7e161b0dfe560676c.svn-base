    ...
    <input name="cust_type" id="proj_info.cust_type" class="td-content-input td-content-readonly" readOnly  type="hidden"  value="${requestScope['proj_info.cust_type'] }"> 
         ...
         <tr>
          ...
          <tr class="tr-contractect-info tr-even">
             ...
             <td class="td-content-title">合同号：</td><td class="td-content"><input name="contract_info.contractnumber" id="contractid" class="td-content-input td-content-readonly" readOnly type="text" value="${requestScope['contract_info.contractnumber']}" require="true" label="合同号" ><font class="required-content">*</font></td>
         </tr>
          ...
          <tr class="tr-contractect-info tr-even">   
           ...
           <tr class="tr-contractect-info tr-even">
             ...
             <!-- 
             <td class="td-content-title">项目规模：</td><td class="td-content"><div class="leftComboContainer" id="id_contract_scale"></div></td>
          -->
          </tr>
          <tr class="tr-contractect-info tr-even">  
          ...
          <tr class="tr-contractect-info tr-odd">   
             <td class="td-content-title">客户经理：</td><td class="td-content"><div class="leftComboContainer" id="id_contract_manage"></div><font class="required-content">*</font></td>
	        ...
	        jQuery(function(){
			    ...
			    new tracywindyComboBox({
			        ...
			        new tracywindyComboBox({
						...
						rawValue:'${empty requestScope["contract_info.projmanage"] ? sessionScope.loginUser.realname : requestScope["contract_info.projmanage"]}',
						params : {
							dealer_id:"${sessionScope['currentDealerCustInfoId']}"
						}
