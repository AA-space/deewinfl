 ...
 * Tenwa
 */
@WorkflowAction(name = "distributorReviewFirstAction", description = "第五步检查同合号", workflowName = "经销商准入评审")
@Component(value = "distributorReviewFirstAction")
public class DistributorReviewFirstAction implements JbpmBaseAction {
