...
function initDeptTree2(){
	...
	$('#id_menu_tabs_menu').tree({
		...
		onBeforeLoad:function(node,params){
		    ...
		    var queryText = jQuery("#id_queryDeptsTableInput2").val().toUpperCase();
			if(queryText && isQueryDeptFlag){
				params['dealerdistrictText'] = queryText;
			}
		},
		onLoadSuccess:function(a,b){
		    //isDeptLoaded = true;
...
<script type="text/javascript">
   ...
   function reloadOperTree(){
	   ...
	   function reloadRightTree(){
		   $('#id_menu_main_content_div_right').tree({
				...
				onBeforeLoad:function(node,params){
					...
					params['pid']  = node ? node.id : "0";
					params['userId']  = "";
					var queryText = jQuery("#id_queryDeptsTableInput3").val().toUpperCase();
					if(queryText && isQueryDeptFlag){
						params['queryText'] = queryText;
					}
					if(!node){
    ...
    jQuery(function(){
	     ...
	     jQuery("#id_queryDeptsTableInput2").keypress(function(e){
	         var code = e.keyCode||e.charCode;
	         if(13 == code){
	        	 isQueryDeptFlag = true;
	             initDeptTree2();
	     ...
	     jQuery("#id_queryDeptsTableInput3").keypress(function(e){
	         var code = e.keyCode||e.charCode;
	         if(13 == code){
	        	 isQueryDeptFlag = true;
	        	 reloadRightTree();
...
<body>
	<div id='menu_main_content' style="float:left;width:325px;overflow:hidden;border:1px solid #DDD;border-top:0px;border-right:0px;padding:5px;">
	   <div class="panel-title" >
	      <SPAN>用户搜索：<INPUT style="BORDER-BOTTOM: #ddd 1px solid; BORDER-LEFT: #ddd 1px solid; WIDTH: 60px; BORDER-TOP: #ddd 1px solid; MARGIN-RIGHT: 4px; BORDER-RIGHT: #ddd 1px solid" id=id_queryDeptsTableInput type="text" jQuery18205254865307538132="34"></SPAN>
	      <SPAN>区域搜索：<INPUT style="BORDER-BOTTOM: #ddd 1px solid; BORDER-LEFT: #ddd 1px solid; WIDTH: 60px; BORDER-TOP: #ddd 1px solid; MARGIN-RIGHT: 4px; BORDER-RIGHT: #ddd 1px solid" id=id_queryDeptsTableInput2 type="text" jQuery18205254865307538132="34"></SPAN>
	   </div>
	...
	<div id='menu_main_oper' style="overflow:hidden;float:left;border-bottom:1px solid #DDD;padding:5px;">
	   <div class="panel-title2" ><font color="red" class="flagUserSelectContainer"style="max-width:210px;float:left;text-overflow:ellipsis; white-space:nowrap; overflow:hidden; "></font>&nbsp;&nbsp;人员角色分配</div>
	...
	<div id='menu_main_oper_right' style="overflow:hidden;float:left;border:1px solid #DDD;border-left:0px;border-top:0px;padding:5px;">
	   <div class="panel-title2" ><font color="red" class="flagUserSelectContainer" style="max-width:210px;float:left;text-overflow:ellipsis; white-space:nowrap; overflow:hidden; "></font>&nbsp;群组分配
	   <SPAN>搜索：<INPUT style="BORDER-BOTTOM: #ddd 1px solid;  BORDER-LEFT: #ddd 1px solid; WIDTH: 45px; BORDER-TOP: #ddd 1px solid; MARGIN-RIGHT: 4px; BORDER-RIGHT: #ddd 1px solid" id=id_queryDeptsTableInput3 type="text" jQuery18205254865307538132="34"></SPAN>
	   </div>
