	...
	var table = new tracywindyOperationTable ({
				...
				tools : [ {
				...
				},
				 {
					    ...
					    var param={id:projIDValue[0].id};
					    ajaxRequest({
						     url:getRootPath()+"/acl/cancelDealerApproval.acl",
						     method:'POST',
			...
			params:{
		  draft:'1',dealertstatus:'dealerApprovalstatus2',dealertstatus1:'dealerApprovalstatus5'
