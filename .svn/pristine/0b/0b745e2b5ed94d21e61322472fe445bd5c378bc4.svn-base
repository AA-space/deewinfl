...
/* 		   {name:'equiptypename', header:'车辆类别',type:'combobox',nullable:false,hiddenName:'equiptype',
		   ...
		   {name:'saleprice',  header:'销售价',type:'double',readOnly:true,nullable:false,otherAttributes:'id="id_saleprice" onkeyup="AdjustTotal()" onkeyup="AdjustMoney()"'},
		   ...
		   {name:'differential_swap',  header:'差额[销售价-采购价]',readOnly:true,type:'double',nullable:false,otherAttributes:'id="id_differential_swap"',readOnly:true,width:160},
		   {name:'purchasetax',  header:'购置税',hidden:true,type:'double',readOnly:true,defaultValue:'0',otherAttributes:'id="id_purchasetax" onkeyup="AdjustTotal()"'},
		   {name:'insuremoney',  header:'保费',hidden:true,type:'double',readOnly:true,defaultValue:'0',otherAttributes:'id="id_insuremoney" onkeyup="AdjustTotal()"'},
		   {name:'leasingmoney',  header:'其他融资额',hidden:true,type:'double',readOnly:true,defaultValue:'0',otherAttributes:'id="id_leasingmoney" onkeyup="AdjustTotal()"'},
