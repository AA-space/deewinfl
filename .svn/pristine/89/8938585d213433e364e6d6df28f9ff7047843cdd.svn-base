...
/* 	var cust_id = getTracywindyObject('id_combo_cust_name').getValue();
	var cust_info = getTracywindyObject('id_combo_cust_name').getRawValue();
...
<body>
	<div id="id_menuDetailInfoForm" class="easyui-window" closed="true" modal="true" title="实际投放" style="display:none;width:600px;height:250px;text-align:center;">
	        <center>
