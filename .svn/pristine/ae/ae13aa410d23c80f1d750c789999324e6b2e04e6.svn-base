 ...
 * Tenwa
 */
@WorkflowAction(name = "noCarReviewEndAction", description = "流程结束动作", workflowName = "项目信审流程(设备)")
@Component(value = "noCarReviewEndAction")
public class NoCarReviewEndAction implements JbpmBaseAction{
