 ...
 * Tenwa
 */
@WorkflowAction(name = "noCarReviewStartAction", description = "流程开始动作", workflowName = "项目信审流程(设备)")
@Component(value = "noCarReviewStartAction")
public class NoCarReviewStartAction implements JbpmBaseAction{
