...
<body>
    ...
    <div class="mini-toolbar miniext-toolbar-top">
        <table class="miniext-form-fit">
            <tr>
	            <td>
	                <a class="mini-button" iconCls="icon-addfolder" plain="true" onclick="createworkflow">合同变更</a>
    ...
    <div class="mini-fit" id="_fit">
        ...
        <div id="custinfo" class="mini-datagrid" style="width:100%;height:100%;" workflow/contract_nocar/contract_change/contract_change_nocar_list.xml
            url="<%=prefix %>/eleasing/workflow/contract_nocar/contract_change/contract_change_nocar_list.xml"  idField="id"
            sizeList="[5,10,20,50]"
        ...
        >
            <div property="columns">
                ...
                <div field="contract_id"  width="120" headerAlign="center" allowSort="true">合同号
                </div>
                <div field="contract_number"  width="120" headerAlign="center" allowSort="true">合同编号
                </div> 
                ...
                <div field="contractstatus" width="120" headerAlign="center" allowSort="true">项目状态</div>
    ...
    <script type="text/javascript">
        ...
        function createworkflow() {
        	...
        	if(row){
        		...
        		startProcess("合同变更流程非车业务-1",attachmentParams); 
        	}else{
        		mini.alert("请选中变更合同流程的项目！！！");
        	}
