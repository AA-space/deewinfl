package com.business.serviceImpl.voucher;
...
import com.business.entity.voucher.InterSubjectInfo;
...
import com.business.service.voucher.IntereasVoucherasstactsService;
...
public class VoucherServiceImpl extends AbstractBaseServiceImpl implements VoucherService {
	 ...
	 * log4j日志 
	 */
	private static final Logger log = Logger.getLogger(VoucherServiceImpl.class);
...
//		log.debug("凭证数据暂时不入库！");
	...
	public void saveVoucher() throws Exception{
		...
		//select ID from inter_orgcode where org_name = '德银租赁'
		...
		map.put("contract_number","德银(2013)租字第00034号");//合同号
