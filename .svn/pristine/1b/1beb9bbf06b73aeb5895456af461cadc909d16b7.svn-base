package com.kernal.interceptor;
...
import com.business.entity.ProcessStatus;
...
public class ActionInterceptor {
	...
	@Pointcut("execution (* com.business.action.leasing..*.*(..))")
	...
	public Object testHandleBody(ProceedingJoinPoint pjp) throws Throwable {
		...
		for (int i = 0; i < args.length; i++) {
			...
			/*if (args[i].getClass().getName().equals("com.business.entity.JBPMWorkflowHistoryInfo")) {
