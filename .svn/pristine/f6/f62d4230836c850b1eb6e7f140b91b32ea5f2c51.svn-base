...
function openWindow(){
	    ...
	    if (!cust_id) {
		    ...
		    return false;
	    	 ...
	    	 var attachmentParams = "proj_id=" + proj_id;
...
<body>
	<div id="id_menuDetailInfoForm" class="easyui-window" closed="true" modal="true" title="项目变更" style="display:none;width:600px;height:250px;text-align:center;">
	        <center>
