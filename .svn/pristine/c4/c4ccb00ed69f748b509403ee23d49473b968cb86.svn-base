...
<body>
	<div style="background: #F6F6F6;">
		<div id="cust_all_info" style="border-width: 0px;height: 100%; width: 100%; overflow-y: auto; background: #FFFFFF">
			<table style="width: 100%">
				<tr>
					<td><iframe id="UserBody" frameborder=0 name="UserBody" style="overflow: auto; border-width: 0px; width: 100%; height: 950px; display: block;"
							src="${pageContext.request.contextPath}/leasing/cust_info/cust_person/cust_person_base.bi?cust_id=<%= request.getParameter("cust_id")%>"
						></iframe></td>
				</tr>
						...
						<div id='id_project_info_tabs_content'>
							<div title="重要个人">
								<div id="id_table_receiverchargeplan_container1" style="overflow: hidden;">
									<iframe frameborder=0 fileLocation="/leasing/cust_info/comm_page/cust_related_person.bi" style="overflow: auto; border-width: 0px; width: 100%; height: 500px; display: block;"> </iframe>
								</div>
							</div>
							<div title="银行账号">
								<div id="id_table_receiverchargehistory_container2" style="overflow: hidden;">
									<iframe frameborder=0 fileLocation="/leasing/cust_info/comm_page/cust_account.bi" style="overflow: auto; border-width: 0px; width: 100%; height: 500px; display: block;"> </iframe>
								</div>
							</div>
							<div title="信用等级">
								<div id="id_table_leasing_fundebankdata_container3" style="overflow: hidden;">
									<iframe  frameborder=0 fileLocation="/leasing/cust_info/comm_page/cust_credit_rank.bi" style="overflow: auto; border-width: 0px; width: 100%; height: 500px; display: block;"> </iframe>
								</div>
							</div>
							<div title="走访调研">
								<div id="id_table_receivercharge_container4" style="overflow: hidden;">
									<iframe frameborder=0 id="id_iframe_cust_info_contact" style="overflow: auto; border-width: 0px; width: 100%; height: 500px; display: block;" fileLocation="/leasing/cust_info/comm_page/cust_contact.bi">
							...
							<div title="关联企业">
								<div id="id_table_receivercharge_container5" style="overflow: hidden;">
									<iframe frameborder=0 style="overflow: auto; border-width: 0px; width: 100%; height: 500px; display: block;" fileLocation="/leasing/cust_info/comm_page/cust_share_company.bi"> </iframe>
								</div>
							</div>
							<div title="股本结构">
								<div id="id_table_receivercharge_container6" style="overflow: hidden;">
									<iframe frameborder=0 fileLocation="/leasing/cust_info/comm_page/cust_stockholder.bi" style="overflow: auto; border-width: 0px; width: 100%; height: 500px; display: block;"> </iframe>
								</div>
							</div>
							<div title="历史交易记录">
								<div id="id_table_receivercharge_container7" style="overflow: hidden;">
									<iframe frameborder=0 fileLocation="/leasing/cust_info/comm_page/cust_historyinfo.bi" style="overflow: auto; border-width: 0px; width: 100%; height: 500px; display: block;"> </iframe>
								</div>
							</div>
						</div>
					</td>
