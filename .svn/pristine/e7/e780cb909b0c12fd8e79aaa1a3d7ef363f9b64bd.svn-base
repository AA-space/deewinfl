...
<body>
	<div id='menu_main_content' style="float:left;width:325px;overflow:hidden;border:1px solid #DDD;border:0px;">
	   <div class="panel-title" style="margin-top:0px;border-top:0px;">数据字典管理<input type="text" style="margin-right:4px;border:1px solid #DDD;" id="id_queryWorkflowsTableInput" value="${param.queryText}" /></div>
