...
<table class="fillTable" cellspacing="0" cellpadding="0">
	<jsp:include page="../financing_credit/finacing_credit03.jsp"></jsp:include>
	<jsp:include page="../financing_drawing/finacing_drawMoney02.jsp"></jsp:include>
	<jsp:include page="../financing_drawing/finacing_draw_proj.jsp"></jsp:include>
	<jsp:include page="../financing_pay/financing_pay01.jsp"></jsp:include>
	<jsp:include page="financing_pay_plan02.jsp"></jsp:include>
</table>
</div>