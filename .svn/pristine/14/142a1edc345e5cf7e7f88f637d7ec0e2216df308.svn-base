	...
	jQuery(function(){
   	 var table = new tracywindyOperationTable({
   		resetFormCallback:function(table,$form,operFlag){
   		 ...
   		 tableComment:'[企业股本结构信息]',
   		 constantFlagTable:'CustStockHolder',
   		 windowTop:20,
   	     border:true,
         ...
         id:'id_table',
         xmlFileName:'/eleasing/jsp/cust_stockholder/cust_stockholder.xml',
         loadMode:'ajax',
         params:param,
         isPage:true,
         isFit:true,
         ...
         columns:[
		            ...
		            {header:'股东名称',name:'stockholdername'},
...
<body>
	...
	<div id="id_detailInfoWindowContainer" buttons="#id-dlg-buttons"  closed="true" modal="true" title="企业股本结构信息" style="display:none;width:800px;height:400px">
	        <center>
			        ...
			        <table style="width:95%" class="fillTable">
			            ...
			            <tr  class="tr-even">
			            	...
			            	<td class="td-content">
			            		...
			            		<input name="custname" id="id_custname" require="true"   maxlength="255"  label="客户名称" readonly="readonly" class="td-content-input td-content-readonly" type="text" /><font class="required-content">*</font></td>
			                <td class="td-content-title"></td><td class="td-content"></td>
			            	
			            </tr>
			            <tr  class="tr-odd">
			            	<td class="td-content-title">股东名称:  </td>  
			            	<td class="td-content" colspan="3">
			            	    <textarea name="stockholdername" require="true" maxB="255"  maxlength="255"   class="td-content-input" style="width:86%" label="主要股东名称"   type="text" ></textarea><font class="required-content">*</font>
			         	  	</td>
			            </tr>
			            <tr  class="tr-even">
			            <td class="td-content-title">法人/个人:  </td>  
			            	<td class="td-content" colspan="3">
			            	 <div id="id_is_stockholdertype" class="leftComboContainer"  maxlength="150"  maxB="150" style="float:left"></div><font class="required-content">*</font></td>
			            </tr>
			            <tr  class="tr-odd">
			            	<td class="td-content-title">身份证/组织机构代码:  </td>  
			            	<td class="td-content" >
			            		<input name="orgcode" require="true" label="身份证/组织机构代码"   maxlength="30"  class="td-content-input" maxB="30"  type="text" /><font class="required-content">*</font>
			            	</td>
			            	<td class="td-content-title">注册资本:  </td>  
			            	<td class="td-content" >
			            		<input name="regcapital" require="true" label="注册资本"  maxlength="30"  dataType="Double"   class="td-content-input" type="text" /><font class="required-content">*</font>
			            	</td>
			            	
			            </tr>
			            <tr  class="tr-even">
			            	<td class="td-content-title">出资方式:  </td>  
			            	<td class="td-content" >
			            		<input name="legalrepresentative" require="true" label="出资方式"  class="td-content-input"  maxlength="150"  maxB="150"  type="text" /><font class="required-content">*</font>
			            	</td>
			            	<td class="td-content-title">出资金额:  </td>  
			            	<td class="td-content" >
			            		<input name="capitalMoney" require="true" label="出资金额"  dataType="Money" maxB="100"  maxlength="100"  class="td-content-input" type="text" /><font class="required-content">*</font>
			            	</td>
			            ...
			            <tr  class="tr-odd">
			            	...
			            	<td class="td-content" >
			            		<input name="shareholding" require="true" label="持股比例"  dataType="Double" maxB="30"  maxlength="30"  class="td-content-input"  type="text" /><font class="required-content" style="color:#000000">%</font><font class="required-content">*</font>
			            	</td>
			     	   ...
			     	   <tr  class="tr-even">
			            	...
			            	<td class="td-content" colspan="3">
			            		<input name="addr" id="addr"  style="width:86%" require="true" label="地址"  class="td-content-input" maxB="255"   maxlength="255"   type="text" /><font class="required-content">*</font>
			            	</td>
			            </tr>
			              <tr  class="tr-odd">
			            ...
			            <tr  class="tr-even">
			            	...
			            	<td class="td-content" colspan="3">
			            	    <textarea name="cshmemo" maxB="255"  maxlength="255"    class="td-content-input" style="width:86%" label="备注"   type="text" ></textarea>
			         	  	</td>
			            </tr>
			           <tr  class="tr-odd">
