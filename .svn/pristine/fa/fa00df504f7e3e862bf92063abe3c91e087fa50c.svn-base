			...
			<div id='id_project_info_tabs_content' style="">
				...
				<div title="风险五级">
					...
					<script language="javascript">jQuery(function() {isViewHistoryTask = isCompletedTask;});</script>
				    	...
				    	<script language="javascript">jQuery("#five_category_content_risk input[name='five_category.contractfivedate_risk']").attr("isForceModify","true");</script>
...
<script>
	function formPageReadOnlyCallBack(){
	    if(!isCompletedTask){
		   formJSPInputHideOrShow("five_category_content_risk","",1);
	    }
	}
	//初始化调用
	jQuery(function() {
