...
public class DefaultTableFormatter implements TableFormatter {
	...
	private void formatData(){
		for(Map<String,CellData> rowDatas : this.datas){
...
//					log.debug("formatted value:{}",f.format(value));
	...
	protected void formatLink(ReportColumn column, Map<String, CellData> datas, CellData cellData) {
	...
	protected Map<String, CellData> formatColorAndLink(Map<String, CellData> datas) {
