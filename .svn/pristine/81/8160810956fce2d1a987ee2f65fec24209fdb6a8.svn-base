    ...
    <table style="width:100% ;" border="1" cellpadding="0" bordercolorlight="#999999"
						...
						<tr class="tr-project-info tr-even tr_td_dashed" >
							...
							<div style="float: left; margin-left: 10px;">
					              <font>
					              是否不计免赔特约：<input name="insurance_price.isinsurance1" type="radio" label="是否不计免赔特约" class="nocalculate" value="是" ${("是"==requestScope['insurance_price.isinsurance1']) ? "checked" : "" } >是
					           			  <input name="insurance_price.isinsurance1" type="radio" label="是否不计免赔特约" class="nocalculate" value="否" ${("否"==requestScope['insurance_price.isinsurance1']) ? "checked" : "" }>否<br>
					              （保险金额按车辆购置发票金额）<input  name="insurance_price.insurance1" class="nocalculate"  label="机动车损失保险及不计免赔特约"  type="text" datatype="PMoney" value="${requestScope['insurance_price.insurance1'] }" >万元</font>
					        </div>
					        </td>
					    ...
					    <tr class="tr-project-info tr-odd tr_td_dashed" >
							...
							<div style="float: left; margin-left: 10px;">
							是否不计免赔特约：<input name="insurance_price.isinsurance2" type="radio" label="是否不计免赔特约" class="nocalculate" value="是" ${("是"==requestScope['insurance_price.isinsurance2']) ? "checked" : "" } >是
						 ...
						 <tr class="tr-project-info tr-even tr_td_dashed">
					        ...
					        <div style="float: left; margin-left: 10px;">
					        <font>
					             是否不计免赔特约：<input name="insurance_price.isinsurance3" type="radio" label="是否不计免赔特约" class="nocalculate" value="是" ${("是"==requestScope['insurance_price.isinsurance3']) ? "checked" : "" }>是
					           			  <input name="insurance_price.isinsurance3" type="radio" label="是否不计免赔特约" class="nocalculate" value="否" ${("否"==requestScope['insurance_price.isinsurance3']) ? "checked" : "" }>否<br>
					             （首次投保保险金额按车辆购置发票金额）<input name="insurance_price.insurance3" label="全车盗抢损失险及不计免赔特约" class="nocalculate"   type="text" datatype="PMoney" value="${requestScope['insurance_price.insurance3']}" >万元<br>
					        </font>
					        </div>
					        </td class="tr_td_dashed">
					     ...
					     <tr class="tr-project-info tr-odd tr_td_dashed">      
					        ...
					        <div style="float: left; margin-left: 10px;">
					        <font>
					        是否不计免赔特约：<input name="insurance_price.isinsurance5" type="radio" label="是否不计免赔特约" class="nocalculate" value="是" ${("是"==requestScope['insurance_price.isinsurance5']) ? "checked" : "" }>是
					           			  <input name="insurance_price.isinsurance5" type="radio" label="是否不计免赔特约" class="nocalculate" value="否" ${("否"==requestScope['insurance_price.isinsurance5']) ? "checked" : "" }>否<br>
					        	驾&nbsp;驶&nbsp;员<input name="insurance_price.insurance41"  class="nocalculate"   label="驾驶员"  type="text" datatype="PMoney" value="${requestScope['insurance_price.insurance4']}" >人
					        	保额<input name="insurance_price.insurance4"  class="nocalculate"   label="保额"  type="text" datatype="PMoney" value="${requestScope['insurance_price.insurance4']}" >元/人
					        </font>
					            </div> 	
					        </td>
					        <td class="tr_td_dashed" style="width:20%" align="center" rowspan="2">
					     ...
					     <tr class="tr-project-info tr-odd tr_td_dashed">
					        ...
					        <font>
					        	...
					        	核定乘客<input name="insurance_price.insurance42" label="核定乘客" class="nocalculate"   type="text" datatype="Number" value="${requestScope['insurance_price.insurance42']}" >人
					     ...
					     <tr class="tr-project-info tr-even  tr_td_dashed">
					     	...
					     	<td class="tr_td_dashed" style="width:60%" >
					     	<div style="float: left; margin-left: 10px;">
					     	是否不计免赔特约：<input name="insurance_price.isinsurance7" type="radio" label="是否不计免赔特约" class="nocalculate" value="是" ${("是"==requestScope['insurance_price.isinsurance7']) ? "checked" : "" }>是
					    ...
					    <tr class="tr-project-info tr-even tr_td_dashed">
					     ...
					     <tr class="tr-project-info tr-odd tr_td_dashed">
					     	...
					     	<td class="tr_td_dashed" style="width:60%" >
					     	<div style="float: left; margin-left: 10px;">
					     	是否不计免赔特约：<input name="insurance_price.isinsurance11" type="radio" label="是否不计免赔特约" class="nocalculate" value="是" ${("是"==requestScope['insurance_price.isinsurance11']) ? "checked" : "" }>是
					           			  <input name="insurance_price.isinsurance11" type="radio" label="是否不计免赔特约" class="nocalculate" value="否" ${("否"==requestScope['insurance_price.isinsurance11']) ? "checked" : "" }>否<br>
					     	<span>
