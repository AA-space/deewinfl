...
<!--发票类型 -->
  <script language="javascript">
    jQuery(function(){
        ...
        if(isInit==true){
	   	    dict('id_rent_invoice_type','proj_invoice_type.rentinvoicetype','rent_invoice_type','${requestScope["proj_invoice_type.rentinvoicetype"]}','${requestScope["rawValue_proj_invoice_type.rentinvoicetype"]}',null,300);
	        //特殊下拉
	        dictYesOrNoByCode('id_IsInvoiceRentSplit','proj_invoice_type.isinvoicerentsplit','${empty requestScope["proj_invoice_type.isinvoicerentsplit"] ? "0" : requestScope["proj_invoice_type.isinvoicerentsplit"] }','',true,null);
	        dictYesOrNoByCode('id_BoolInvoice','proj_invoice_type.boolinvoice','${empty requestScope["proj_invoice_type.boolinvoice"] ? "0" : requestScope["proj_invoice_type.boolinvoice"] }','',true);
...
<table class="fillTable" cellspacing="0" cellpadding="0" id="proj_invoice_type_table">
	<tr class="tr-even">
