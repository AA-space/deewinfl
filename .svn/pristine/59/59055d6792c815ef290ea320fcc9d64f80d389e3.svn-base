...
var tools=[ {
	...
	handler : function(table) {
    	...
    	var fileparames={ids:tempIdArr.join(","),currentLoginRealName:'${sessionScope["login_realname"]}',url:url,title:"资金发票实收开票确认",twoClassify:'fundinvoiceconfirm',returnType:'file',modelname:'fundinvoiceconfirm'};
    	for(var p in params){
...
<script type="text/javascript">
	jQuery(function(){
		...
		//toolsLeftMargin:200,
         ...
         title:'资金发票实收开票确认',
         id:'id_table',
         xmlFileName:'/eleasing/jsp/invoice_manage/fund_invoice/fund_invoice_charge_confirm.xml',
         loadMode:'ajax',
         isPage:true,
         isFit:false,
         isCheck:true,
        ...
        columns:[
		            ...
		            {header:'收款金额',name:'planmoney',type:'double',queryConfig:{}},
		            ...
		            {header:'开票金额',name:'planmoney',type:'double',queryConfig:{}},
