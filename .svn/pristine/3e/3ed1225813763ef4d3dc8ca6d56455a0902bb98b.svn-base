    ...
    jQuery(function(){
    	...
    	new tracywindyMultiTable({
    	    ...
    	    columns:[
    	       ...
    	       {name:'refund_status',  header:'状态',nullable:false,type:'double'},
    	       {name:'refund_corpus',  header:'本金金额',nullable:false,type:'double'},
    	       {name:'refund_interest',  header:'利息金额',nullable:true,type:'double'},
    	       {name:'refund_money',  header:'本息合计',type:'double'},
    	       {name:'refund_otherfee_money',  header:'其他费用',type:'double'},
    	       {name:'refund_otherfee_type',  header:'其他费用类型',type:'double'},
    	       {name:'refund_subtotal',  header:'还款金额小计',type:'double'},
		...
		<div class="toggle-icon-expanded" title="折叠" toggleClass="tr_pay_plan1"></div>
		还款计划一览</td>
  		</tr>
        <tr class="tr_pay_plan1">
         <td colspan=4>
         <div><div id="id_pay_plan1"></div></div>
            </td>
        </tr>
