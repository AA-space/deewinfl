<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    //######项目上基本信息#########  
    	...
    	dict('id_dealerapprovalstatus','dealer_approval_info.dealerStatus','dealer_intoStatue','${requestScope["dealer_approval_info.dealerStatus"]}',null,'require="true" label="准入申请状态"');    
    ...
    <table cellspacing="0" cellpadding="0"  id="proj_base_info">
          ...
          <tr class="tr-project-info tr-odd">
             <td class="td-content-title">准入申请状态：</td><td class="td-content" ><div class="leftComboContainer" id="id_dealerapprovalstatus"></div><font class="required-content">*</font></td>
             <td class="td-content-title"></td><td class="td-content">
             </td>
         </tr>
         <tr class="tr-project-info tr-odd" id="dealer_approval_info_memo">
             <td class="td-content-title">准入审批意见：</td>
             <td class="td-content" colspan="3">
             <textarea label="准入审批意见"  class="td-content-input"
				style="width: 98%;height:100px" name="dealer_approval_info.memo">${requestScope['dealer_approval_info.memo'] }</textarea>
             </td>
         </tr>
