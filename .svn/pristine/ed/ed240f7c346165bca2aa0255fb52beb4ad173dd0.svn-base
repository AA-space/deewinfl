   ...
   <div id="proj_change_form1">
	    <table class="fillTable" cellspacing="0" cellpadding="0">
	          <tr class="tr-project-info tr-odd">
	             ...
	             <td class="td-content">
	             <input id="id_proj_info_repealreasontype" name="proj_info.dictionarydatabyrepealreasontype"   class="mini-combobox" textField="name"  required="true"
		                  	   valueField="value"  
							   dataField="datas"
							   allowInput="false" 
							   data-options="{_params:{pid:'repeal_type'}}" 
							   onbeforeshowpopup="onbeforeshowpopup"
							   value="${requestScope['proj_info.dictionarydatabyrepealreasontype'] }" 
							   text="${requestScope['rawValue_proj_info.dictionarydatabyrepealreasontype']}" 
							   onvaluechanged="comboboxChanged(e)"
				 />
				 <input id="rawValue_proj_info.dictionarydatabyrepealreasontype" name="rawValue_proj_info.dictionarydatabyrepealreasontype"  class="mini-textbox" style="display:none"/>
	             </td>
	          </tr>
	          ...
	          <tr class="tr-project-info tr-odd">
	             ...
	             <input id="id_proj_info_repealreason" style="width:73%" name="proj_info.repealreason"  required="true" label="撤销原因" class="mini-textarea"  type="text" > 
	             </td>
	          </tr>
...
<script language="javascript">
	...
	debugger;
	var repealreasontype = parent.document.getElementById("id_proj_info_dictionarydatabyrepealreasontype").value;
	var raw_repealreasontype = parent.document.getElementById("id_rawValue_proj_info_dictionarydatabyrepealreasontype").value;
	mini.get("id_proj_info_repealreasontype").setValue(repealreasontype);
	mini.get("id_proj_info_repealreasontype").setText(raw_repealreasontype);
