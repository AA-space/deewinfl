...
public class DeviCalTest {
	...
	public DeviCalTest(String year_rate, String income_number, String lease_money,
			String lease_interval, String plan_date, String period_type,
			List l_adjust) {
	...
	public static void main(String[] args) {
		DeviCalTest hr = new DeviCalTest();
