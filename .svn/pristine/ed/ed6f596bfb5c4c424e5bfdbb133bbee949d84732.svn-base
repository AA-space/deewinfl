...
<div class="fillTableContainer">
   <table class="fillTable" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td colspan=4> <jsp:include page="../review/nocar_review_report_info.jsp"></jsp:include></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan=4><!-- 插入项目信审结论 -->
		 <jsp:include  page="../../project/proj_credit/proj_credit_result_info.jsp"></jsp:include></td>
	</tr>
	<tr>
...
<jsp:include page="../nocar_public/guarantee_method.jsp"></jsp:include><%--担保 --%>
<%--结束--%>
<script>
	//隐藏域在提交或保存前的赋值
