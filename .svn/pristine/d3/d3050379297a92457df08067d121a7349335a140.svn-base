...
<input type="hidden" id="id_json_stockholder_info_str" 
	   name="json_stockholder_info_str"
 	   value='${empty json_stockholder_info_str ? "[]" : json_stockholder_info_str }'></input>
...
<div class="fillTableContainer">
   <table class="fillTable" cellspacing="0" cellpadding="0">
	...
	<tr>
	<td>
	<div id="id_table_leasing_stockholder_info_container"><!-- 插入股东构成信息 -->
			<jsp:include page="../apply/nocar_stockholder_info.jsp"></jsp:include>
	</div>
	</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan=4><!-- 插入项目其它基本信息 --> <jsp:include
			page="../apply/nocar_apply_other_info.jsp"></jsp:include></td>
	</tr>
	<!--<tr>
	...
	<tr class="tr-project-business-condition">
		...
		<div id="id_table_leasing_proj_change_info_container"
			...
			<jsp:include page="../../project/proj_cancel/proj_cancel_info.jsp"></jsp:include>
			<script language="javascript">
			    jQuery(function() {isViewHistoryTask = true;});
					...
					<div title="租金发票类型">
						...
						<div id="id_table_leasing_proj_rent_type_container"
							style="height: 350px;"><jsp:include page="../../project/proj_approval/proj_invoice.jsp"></jsp:include>
						</div>
					</div>
			</div>
		</td>
