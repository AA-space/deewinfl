...
public interface BaseService {
	...
	// * @throws Exception
	// */
	// public Object updateMainEntity(Class mainObjectClass,Map<String,Object> propertiesMap,Map sourceMapModel,Map<String,String> classFieldMapping,String... entityIdentifier)
	// throws Exception;
	//
	// /**
	...
	// * @throws Exception
	// */
	// public Object updateOneToOneEntity(Object mainObject,String toUpdatedObjectFieldName,String toMainObjectFieldName,Map sourceMapModel,Map<String,String>
	// classFieldMapping,String... entityIdentifier) throws Exception;
	//
	// /**
	...
	// * @throws Exception
	// */
	// public <V,T> Collection<T> updateOneToManyCollections(T OneToManyObj,String OneToManyFieldName,Class<V> ManyToOneObjClass,String ManyToOneFieldName,String
	// jsonArrayStr,Map<String,String> classFieldMapping,String... entityIdentifier ) throws Exception;
	// public <T> Collection<T> updateOneToManyCollectionsNoRemoved(Object OneToManyObj,String OneToManyFieldName,Class<?> ManyToOneObjClass,String ManyToOneFieldName,String
	// jsonArrayStr,Map<String,String> classFieldMapping,String... entityIdentifier ) throws Exception;
	// /**
	...
	public <T, V> Collection<V> updateOneToManyCollections(T OneToManyObj, String OneToManyFieldName, Class<V> ManyToOneObjClass,
			String ManyToOneFieldName, String jsonArrayStr, Map<String, String> classFieldMapping, String... entityIdentifier)
			throws Exception;

	public <T, V> Collection<V> updateOneToManyCollectionsNoRemoved(T OneToManyObj, String OneToManyFieldName, Class<V> ManyToOneObjClass,
			String ManyToOneFieldName, String jsonArrayStr, Map<String, String> classFieldMapping, String... entityIdentifier)
			throws Exception;
