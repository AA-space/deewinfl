...
import com.business.dao.ResourceDao;
import com.business.service.ResourceService;
...
public class ResourceServiceImpl implements ResourceService {
	...
	public Map<String, Object> getProcessStatus(int page, int pagesize) throws Exception {
		...
		String queryString = "SELECT new Map("+columns+", CONCAT(T2.activityName,'(', T2.activityAction, ',', T2.activityType ,')') as pointDsiplay, T3.workflowName as workFlowDispaly) FROM  com.business.entity.ProcessStatus T1, ActivityDetail T2, com.business.entity.JbpmWorkflowDesigner T3 WHERE T1.pointName = T2.id AND T1.workFlowName = T3.id ORDER BY T1.workFlowName, T1.pointName, T1.actionMethod";
