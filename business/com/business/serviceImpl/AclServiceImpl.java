...
import com.business.entity.PermissionCache;
...
import com.kernal.enums.PermissionEnum;
...
public class AclServiceImpl extends AbstractBaseServiceImpl implements AclService
{
	...
	public void saveOrUpdatePermissionCachedToDB(
		...
		String[] permessionKeys  = {
				"AllXMLTable","AllXMLChart","UserOwnedMenusJson",
				"UserOwnedResources","UserOwnedActions","UserOwnedWorkflowStarts",
				"UserOwnedWorkflowViews","ResourceOwnedUsers",
				"UserOwnedWorkflowStartSqlIdsStr","UserOwnedWorkflowViewSqlIdsStr"
		};
		Object[] permessionObjs  = {
				allXMLTable,allXMLChart,userOwnedMenusJson,
				userOwnedResources,userOwnedActions,userOwnedWorkflowStarts,
				userOwnedWorkflowViews,resourceOwnedUsers,
				userOwnedWorkflowStartSqlIdsStr,userOwnedWorkflowViewSqlIdsStr
	...
	@Override
	//@TriggersRemove(cacheName = "menusTreeMenuCache", when = When.AFTER_METHOD_INVOCATION, removeAll = true) 
	...
	//资源
	@Override
	public void   saveOrUpdateResourceWithPosition(com.business.entity.Resource resource,String parentResourceId, String currentPosition) throws Exception{
	...
	public void   removeResource(String resourceId) throws Exception{
		this.aclDao.removeEntityById(com.business.entity.Resource.class, resourceId);
		ResourceUtil.setNeedUpdatePermissionCache(true);
	}
	   //操作action
	@Override
	...
	public String getDictionariesTreeMenu(String rootParentDictId)
			throws Exception {
	...
	@Override
	@TriggersRemove(cacheName = "dictionariesTreeMenuCache", when = When.AFTER_METHOD_INVOCATION, removeAll = true) 
	public void saveOrUpdateDictionaryWithPosition(Dictionary dictionary,
			String parentDictId, String currentPosition) throws Exception 
    {
	...
	public String getBaseDocumentConfigsTreeMenu(
			String rootParentBaseDocumentConfig) throws Exception {
	...
	@Override
	@TriggersRemove(cacheName = "baseDocumentConfigsTreeMenuCache", when = When.AFTER_METHOD_INVOCATION, removeAll = true) 
	public void saveOrUpdateBaseDocumentConfigWithPosition(
			BaseDocumentConfig baseDocumentConfig, String parentDocumentId,
			String currentPosition) throws Exception {
	...
	@Override
	public void saveOrUpdateDictionaryDataWithPosition(
			DictionaryData dictionaryData, String parentDictDataId,
			String currentPosition) throws Exception {
		this.aclDao.saveOrUpdateEntity(dictionaryData);
		this.aclDao.updateFlush();
	...
	@Override
	//@TriggersRemove(cacheName = "deptsTreeMenuCache", when = When.AFTER_METHOD_INVOCATION, removeAll = true) 
	public void removeDept(String deptId) throws Exception {
		this.aclDao.removeEntityById(Department.class,deptId);
	}
	@Override
	//@TriggersRemove(cacheName = "deptsTreeMenuCache", when = When.AFTER_METHOD_INVOCATION, removeAll = true) 
	public void saveOrUpdateDeptWithPosition(Department dept,
			String parentDeptId, String currentPosition) throws Exception {
	...
	@Override
	public void addOrRemoveDistribute(String entityClassName,
		  ...
		  boolean isNeedRecursionChildrenDepts = 
			    "MenuDepartment".equals(entityClassName)
			  ||"ResourceDepartment".equals(entityClassName)
			  ||"ActionDepartment".equals(entityClassName);
		  String flag = "add";
		  ...
		  {	
		       ...
		       if(l.size()>0){
		    	   ...
		    	   String className = "com.business.entity."+entityClassName;
	...
	@SuppressWarnings("unchecked")
	public void addRecursionDistributeParentMenu(Menu menu,String entityClassName, String rightFieldName,
			String rightIds)  throws Exception {
	...
	@SuppressWarnings("unchecked")
	public void removeRecursionDistributeChildrenMenus(Menu menu,String entityClassName, String rightFieldName,
			String rightIds) throws Exception {
		Assert.notNull(rightIds);
		String leftFieldName = "menu";
	...
	public String addUser(Map<String, String> model) throws Exception 
	{
		   ...
		   String dealerdistrict = model.get("dealerdistrict");
		   if(null != dealerdistrict){
			   whereMap.put("code",dealerdistrict );
			   dict=(DictionaryData)this.findEntityByProperties(DictionaryData.class, whereMap).get(0);
			   user.setDealerDistrict(dict);
		   }
