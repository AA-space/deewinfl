...
/* 				new tracywindyTable({
			...
			function doModifyPasswordOperation()
			{
				...
				if(newPassword.length < <%=com.kernal.utils.ResourceUtil.getMinPasswordLength()%>)
				{
					alert("新密码不能少于<%=com.kernal.utils.ResourceUtil.getMinPasswordLength()%>位!");
					jQuery("#id_newPassword").focus();
					return;
			    }
			    /*if(!(new RegExp("<%=com.kernal.utils.ResourceUtil.getMinPasswordLength()%>").test(newPassword))){
