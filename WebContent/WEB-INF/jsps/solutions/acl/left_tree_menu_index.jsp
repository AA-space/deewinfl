...
<html>
	<head>
	   <title><spring:message code="FinancingLeaseBusinessSystem"  text="FinancingLease"/>-V4.5</title>
	   ...
	   var userId = "${sessionScope.loginUser.id}";
		 ...
		 ajaxRequest({
			...
			<body >
	          ...
	          <div class="header" style="overflow:hidden;" >
			      ...
			      <div class="main_topbg" id='id_mainPage_header'>
						<div class="main_logo"><a>德银融资租赁业务系统<font class="font_cls"> </font></a></div>
						...
						<div class="main_time" style="display:none;">
						    ...
						    <a href="javascript:void(0);" onClick="javascript:shwoMessageWindwos(true);" ><img src="${pageContext.request.contextPath}/menuIcons_w/mail.png" style="top:3px;margin-right:5px;position:relative;" border="0" /><span id="emailNum"></span></a>
						    <a href="javascript:void(0);" onClick="javascript:showPersonalSettingWindow();" ><spring:message code="PersonalSetting"  text="个人设置"/></a>&nbsp;
						    <a href="javascript:void(0);" onClick="javascript:showModifyPasswordWindow();" ><img src="${pageContext.request.contextPath}/menuIcons_w/cogs.png" style="top:3px;margin-right:5px;position:relative;" border="0" /><spring:message code="Modify"  text="Modify"/></a>
						    <a id="id_delegateTooLink" href="javascript:void(0);" onClick="javascript:showDelegateWindow();" ><img src="${pageContext.request.contextPath}/menuIcons_w/key.png" style="top:3px;margin-right:5px;position:relative;" border="0" /><spring:message code="Delegate"  text="Delegate"/></a>
						    <permission:action  code="dealer_action"><script type="text/javascript">jQuery("#id_delegateTooLink").hide();</script></permission:action>
					        <a href="javascript:void(0);" onClick="javascript:showlogoutWindow();" style='text-decoration: none;' ><img style="top:3px;margin-right:5px;position:relative;" src="${pageContext.request.contextPath}/menuIcons_w/on-off.png" border="0" /><spring:message code="Logout"  text="Logout"/></a>
					        <br/>
					        <!--  
					        <c:choose>
			...
			<div style="padding-top:4px;padding-left:4px;padding-right:4px;" onmouseover='jQuery("body>div.menu-top").menu("hide");'> <!--1112 helen change padding-top-->	
				<div id='main_content' style="border-right:0px;">
					<div region="center"  style="overflow:hidden;border-width:0px;" id='id_main_content_div'>
					        ...
					        <script type="text/javascript">
					         ...
					         iframeContent.css("width",(iframe_clientWidth-6)+"px");
	        ...
	        <script>
	            ...
	            function doCheckTreeByMenuId(firstLevelMenuId,menuId){
	        		...
	        		jQuery("a[id^='id_menuButton_'][firstLevelMenuId='"+firstLevelMenuId+"']").click();
		        }
	        </script>
	        <!--个人设置结束 -->
	        <!--站内信开始 -->
		...
		<permission:action  code="mynoticemulti">
		<script type="text/javascript">
				var tools=[ {
		  			html : '<font color="red">设置为已读</font>',
		  			handler : function(table) {
		 				var checkedRowdata = table.getCheckedRowDatas();
		 				debugger;
		 				if (0 == checkedRowdata.length) {
		 					alert("请选择需要修改的数据！");
		 					return false;
		 				}
		 				var tempIdArr = [];
		 				for(var i = 0;i<checkedRowdata.length;i++){
		 					var id = checkedRowdata[i].bid;
		 					tempIdArr.push(id);
		 				}
		 				var params = {};
		 				params["ids"] = tempIdArr.join(",");
		 				params["user_id"]="${sessionScope.loginUser.id}";
		 				params["read_status"]="0";
						var url = "${pageContext.request.contextPath}/leasing/markMultiAsRead.action";
						ajaxRequest({
					    	 method:'POST',
					         url:url,
					         params:params,
				...
				//站内公告
				 var mynotice = new tracywindyOperationTable({
				         ...
				         columns:[
					            ...
					            {header:'主题',name:'msgtitle',renderer:showMyNotice,queryConfig:{}},
					            {header:'上报时间',name:'senddate'},
					            {header:'上报人',name:'realname',queryConfig:{}},
