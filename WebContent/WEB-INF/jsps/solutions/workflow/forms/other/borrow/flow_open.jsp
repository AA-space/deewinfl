...
combo_cust = new tracywindyComboBox({
    ...
    onSelect:function(combo){
        ...
        combo_contract.setParam("custID",cust_id);
        }
 });
combo_contract = new tracywindyComboBox({
...
dictOnSelect('id_document_borrow','document_borrow','document_borrow','document_borrow_1',null,null,null,300);
});
function openWindow(){
    ...
    if (!cust_id) {
	    ...
	    return false;
    	 ...
    	 var attachmentParams="cust_id="+cust_id+"&contract_id="+contract_id;
    	 startProcess("借阅流程-1",attachmentParams);
    }
}
...
<body>
	<div id="id_menuDetailInfoForm" class="easyui-window" closed="true" modal="true" title="借阅流程" style="display:none;width:600px;height:250px;text-align:center;">
	        <center>
		        <div style="width:90%;padding-top:30px;">
			        <table align="center">
			        	<tr><td class="input_label_desc">模式:</td><td  class="input_value"><div id="id_document_borrow" style="float:left;"></div></td><td><span class="content-required">*</span></td></tr>
