...
<input type="hidden" id="id_proj_info_repealreason" name="proj_info.repealreason" value="${requestScope['proj_info.repealreason']}"></input>
	...
	<div class="fillTableContainer">
		<table class="fillTable" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td colspan=4>
					<div class="mini-panel" title="商务条件" showCollapseButton="true" style="width: 99%;">
					  <div id="tabDeatils" class="mini-tabs" activeIndex="0"
						style="width: 100%; height: 600px" bodyStyle="padding:0;border:0;">
						<div title="变更说明" name="changeDetail" iconCls="icon-cut" url="<%=request.getContextPath()%>/workflow/forms/project_nocar/proj_change_nocar/proj_change_detail.bi">
							
						</div>

						<div title="租赁物明细" name="equipList" iconCls="icon-cut" url="<%=request.getContextPath()%>/workflow/forms/project_nocar/proj_approval_nocar/proj_equip_detail.bi">
						...
						<div title="担保单位信息" name="guaranteeDetail" iconCls="icon-cut" url="<%=request.getContextPath()%>/workflow/forms/project_nocar/proj_approval_nocar/proj_guarantee_detail.bi">
						</div>
						<div title="抵押物信息" name="guarantyDeatil" iconCls="icon-cut" url="<%=request.getContextPath()%>/workflow/forms/project_nocar/proj_approval_nocar/proj_guaranty_detail.bi">
						</div>
					 </div>
					</div>
				</td>
...
<script type="text/javascript">
        function fillHiddenVal(type){
        	...
        	var Tab0 = tabs.getTab("changeDetail");
