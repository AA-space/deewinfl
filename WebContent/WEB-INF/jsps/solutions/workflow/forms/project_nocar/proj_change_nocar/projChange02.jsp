				...
				<td colspan=4>
					<div class="mini-panel" title="商务条件" showCollapseButton="true" style="width: 99%;">
					 ...
					 <div id="tabDeatils" class="mini-tabs" activeIndex="0"
						...
						<div title="变更说明" name="changeDetail" iconCls="icon-cut" url="<%=request.getContextPath()%>/workflow/forms/project_nocar/proj_change_nocar/proj_change_detail.bi?isViewHistoryTask=true">
