...
<div class="mini-panel" title="与其他融资企业的相关交易情况" showCollapseButton="true" style="width: 100%;">
    ...
    <div class="mini-toolbar miniext-toolbar-top">
        <table class="miniext-form-fit">
            <tr>
	            <td>
	                <a class="mini-button" iconCls="icon-addfolder" plain="true" onclick="addCorporinfoRow">增加</a>
	                <span class="separator"></span>
	                <a class="mini-button" iconCls="icon-remove" plain="true" onclick="removeCorporinfoRow">删除</a>
	            </td>
            </tr>
        </table>
    </div>
    <!--grid展示--撑满页面-->
    <div id="corporationgrid" class="mini-datagrid" style="width:100%;height:250px;" dataField="datas" contextMenu="#gridMenu"
        url=""  
    ...
    <input type="hidden" id="id_json_corporationgrid" name="json_corporationgrid" value='${empty json_corporationgrid ? "[]" : json_corporationgrid }'></input>
</body>
<script>
	function addCorporinfoRow() {
		var assetinfogrid = $mini("corporationgrid");
	    var newRow = {};
	    assetinfogrid.addRow(newRow, 0);
	    assetinfogrid.beginEditCell(newRow);
	}
	function removeCorporinfoRow() {
		var assetinfogrid = $mini("corporationgrid");
