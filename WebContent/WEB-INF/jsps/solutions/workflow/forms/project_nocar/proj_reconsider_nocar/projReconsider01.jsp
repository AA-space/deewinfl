...
<body>
	...
	<input type="hidden" id="id_proj_info_colunm1" 	name="proj_info_colunm1" value="${requestScope['proj_info_colunm1']}"></input>
    <input type="hidden" id="id_proj_info_colunm2" 	name="proj_info_colunm2" value="${requestScope['proj_info_colunm2']}"></input>
    <input type="hidden" id="id_proj_info_colunm3" 	name="proj_info_colunm3" value="${requestScope['proj_info_colunm3']}"></input>
    <input type="hidden" id="id_proj_info_colunm4" 	name="proj_info_colunm4" value="${requestScope['proj_info_colunm4']}"></input>
				...
				<td colspan=4>
					<div class="mini-panel" title="项目商务条件" maskOnLoad="false" showCollapseButton="true" style="width: 100%;height:auto;">
							<div class="mini-tabs" activeIndex="0" plain="false" borderStyle="border:0" style="width: 100%;height:900px;" id="tab1" >
								<div title="复议内容" name="reconsiderDetail" iconCls="icon-cut" url="<%=request.getContextPath()%>/workflow/forms/project_nocar/proj_reconsider_nocar/proj_reconsider_detail.bi">
								</div>
							    ...
							    <div title="考察报告（自然人）" name="personDetail" iconCls="icon-cut">
							        <jsp:include page="../proj_credit_nocar/proj_person_report_comm.jsp"></jsp:include>
							    </div>
							    <div title="考察报告（法人）" name="companyDetail"   iconCls="icon-cut">
							    <jsp:include page="../proj_credit_nocar/proj_credit_report.jsp" ></jsp:include>
							    </div>
							    <div title="文件清单" name="fileDetail"   iconCls="icon-cut" url="<%=request.getContextPath()%>/workflow/forms/project_nocar/proj_credit_nocar/proj_person_report_fileinfo.bi" >
							        
							    </div>
							    <div title="生成客户信审报告" name="creditReportxls"   iconCls="icon-cut" url="<%=request.getContextPath()%>/workflow/forms/project_nocar/project_comm_nocar/credit_report/proj_credit_reportxls.bi">
...
//         }, 2000);
    ...
    function fillHiddenVal(type){
    	...
    	var Tab0 = tabs.getTab("reconsiderDetail");
    	...
    	if(typeof(iframe0)!='undefined'){
    		...
    		//保存子页面数据
    		var o = grid0.getData();
    		$("#id_proj_info_colunm1").val(mini.formatDate (o.colunm1,"yyyy-MM-dd"));
    		$("#id_proj_info_colunm2").val(o.colunm2);
    		$("#id_proj_info_colunm3").val(o.colunm3);
    		$("#id_proj_info_colunm4").val(o.colunm4);
    		if("submit"==type){
    		   grid0.validate();
