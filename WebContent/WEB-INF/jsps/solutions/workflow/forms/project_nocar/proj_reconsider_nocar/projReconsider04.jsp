...
<body>
	...
	<div class="fillTableContainer">
		<table class="fillTable" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td colspan=4>
					<!-- 插入项目基本信息 --> <jsp:include page="proj_credit_result_info.jsp"></jsp:include></td>
			</tr>
			<tr>
				<td colspan=4>
					<div id="projectinfo" class="mini-panel" title="项目商务条件" maskOnLoad="false" showCollapseButton="true" style="width: 100%;height:auto;">
							<div class="mini-tabs" activeIndex="0" plain="false" borderStyle="border:0" style="width: 100%;height:900px;" id="tab1" >
								<div title="复议内容" name="reconsiderDetail" iconCls="icon-cut" url="<%=request.getContextPath()%>/workflow/forms/project_nocar/proj_reconsider_nocar/proj_reconsider_detail.bi?isViewHistoryTask=true">
								</div>
