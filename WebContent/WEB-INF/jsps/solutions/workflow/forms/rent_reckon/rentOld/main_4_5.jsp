...
<div class="fillTableContainer">
   <table class="fillTable" cellspacing="0" cellpadding="0">
	<tr>
 	...
 	<tr>
           <td class="x-panel-table-div-title" colspan=6><div class="toggle-icon-expanded" title="折叠" toggleClass="tr-contract-plan-condition"></div>租金计划[原]</td>
    </tr>
...
<div id="id_table_leasing_fund_cash_flow_container_old"	style="overflow: hidden;display: none;">
	<jsp:include page="fund_cash_plan_frame.jsp" flush="true"/>
</div>
</c:if>
<script>
