...
<body>
	<div id="id_menuDetailInfoForm" class="easyui-window" closed="true" modal="true" title="租金计划修改" style="display:none;width:600px;height:250px;text-align:center;">
	        <center>
