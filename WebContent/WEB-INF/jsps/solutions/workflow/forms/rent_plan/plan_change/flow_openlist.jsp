   ...
   var param={};
	...
	jQuery(function(){
   	 var table = new tracywindyOperationTable({
   		 tableComment:'[租金计划变更]',
   		 constantFlagTable:'FundPlanChange',
   		 windowTop:20,
   	     border:true,
         ...
         loadMode:'ajax',
         params:{
   			custdealerid:"${sessionScope['currentDealerCustInfoId']}",
         ...
         tools:[{
        	 html : '<font color="red">租金计划变更</font>',
         ...
         columns:[
		            ...
		            {header:'客户经理',name:'projmanage',queryConfig:{}}
         ]
   	 });
   });
