...
<div class="fillTableContainer">
   <table class="fillTable" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td colspan=4><!-- 插入项目其它基本信息 --> <jsp:include page="../proj_approval/proj_base_other_info.jsp"></jsp:include>
		</td>
	</tr>
   <tr>	 
	...
	<tr class="tr-project-business-condition">
		...
		<div id="id_table_leasing_proj_change_info_container"
			style="overflow: hidden;"><jsp:include page="proj_change_info.jsp"></jsp:include></div>
		</div>
		<div title="租赁物明细">
...
<script>
	...
	function formPageReadOnlyCallBack(){
		getNow();
		formJSPInputHideOrShow("changedetils","",1);
	}
	function getNow()
	{		
       var now =new Date();
       ...
       jQuery('#proj_other_info.projchangedate').val(nowDate);
    }
</script>
