...
/* 		   {name:'equiptypename', header:'车辆类别',type:'combobox',nullable:false,hiddenName:'equiptype',
           ...
           {name:'isaffiliated', header:'是否挂靠id',hidden:true},
  		   {name:'affiliatedinfo', header:"挂靠单位及法人信息",type:'textarea',otherAttributes:'maxB="2000" id="id_affiliatedinfo" onblur="AdjustAffiliatedinfo()" '},
...
function AdjustAffiliatedinfo()
{
	 var id_affiliatedinfo = jQuery("#id_affiliatedinfo").val();
	 id_affiliatedinfo=id_affiliatedinfo.replace(/\n/g,'');
	 jQuery("#id_affiliatedinfo").val(id_affiliatedinfo.trim());
}
</script>
