...
<script type="text/javascript">
    jQuery(function(){
    	dictYesOrNoByCode('id_credit_type','financing_credit.credit_type',null,null,null,'label="担保"');
...
<table class="fillTable" cellspacing="0" cellpadding="0">
	...
	<jsp:include page="finacing_drawMoney02.jsp"></jsp:include>
	<jsp:include page="finacing_draw_proj.jsp"></jsp:include>
	<jsp:include page="finacing_draw_sxf.jsp"></jsp:include>
</table>
