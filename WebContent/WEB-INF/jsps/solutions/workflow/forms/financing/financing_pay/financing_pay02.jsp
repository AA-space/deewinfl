    ...
    jQuery(function(){
    	...
    	new tracywindyMultiTable({
    	    ...
    	    columns:[
    	       ...
    	       {name:'refund_list', header:'还款期次',nullable:false,type:'double'},
    	       {name:'refund_plan_date',  header:'计划日期',nullable:true,type:'double'},
    	       {name:'refund_plan_date',  header:'实际还款日期',nullable:true,type:'double'},
    	       {name:'refund_corpus',  header:'计划本金金额',nullable:false,type:'double'},
    	       {name:'refund_interest',  header:'计划利息金额',nullable:true,type:'double'},
    	       {name:'refund_money',  header:'计划本息合计',type:'double'},
    	       {name:'refund_corpus',  header:'实际本金金额',nullable:false,type:'double'},
    	       {name:'refund_interest',  header:'实际利息金额',nullable:false,type:'double'},
    	       {name:'refund_money',  header:'实际本息合计',type:'double'},
    	      
    	       {name:'refund_otherfee_money',  header:'计划其他费用',type:'double'},
    	       {name:'refund_otherfee_money',  header:'实际其他费用',type:'double'},
    	       {name:'refund_otherfee_type',  header:'其他费用类型',type:'double'},
    	       {name:'refund_subtotal',  header:'计划还款金额小计',type:'double'},
    	       {name:'refund_subtotal',  header:'实际还款金额小计',type:'double'},
