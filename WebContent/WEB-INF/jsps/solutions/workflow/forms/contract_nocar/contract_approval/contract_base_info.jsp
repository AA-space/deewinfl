    ...
    <div class="mini-panel" title="合同信息" showCollapseButton="true" style="width: 99%;">
	    <table class="fillTable" cellspacing="0" cellpadding="0" id="proj_base_info" >
	          ...
	          <tr class="tr-project-info tr-even">
	             <td class="td-content-title">项目编号：</td><td class="td-content">
	             <input name="contract_info.proj_id" id ="project_id"  class="mini-textbox" readOnly type="text" value="${requestScope['contract_info.proj_id']}"></td>
	             <td class="td-content-title">合同编号：</td><td class="td-content">
	             <input  name="contract_info.contractid" class="mini-textbox" readOnly value="${requestScope['contract_info.contractid'] }"  required="true" allowInput="false"/>
	             <font class="required-tag">*</font>
	             </td>
	         </tr>
	          <tr class="tr-project-info tr-odd">
	             <td class="td-content-title">项目名称：</td><td class="td-content" colspan=5><input style="width:50%" name="contract_info.projectname" id="project_name"  required="true" label="项目名称" class="mini-textbox"  type="text" value="${requestScope['contract_info.projectname']}"  onclick="createProjectName();" >
	          ...
	          <tr class="tr-project-info tr-even">
	             ...
	             <td class="td-content">
	              <input name="contract_info.custnumber" class="mini-textbox" readOnly  type="text"  value="${requestScope['contract_info.custnumber'] }"/>
	              <font class="required-tag">*</font>
	             </td>
	                
	             <td class="td-content-title">承租单位：</td><td class="td-content">
	             <input id="cust_name" name="contract_info.custname" class="mini-textbox" readOnly require="true" label="承租单位"  type="text" value="${requestScope['contract_info.custname'] }" >
	             <font class="required-tag">*</font>
	               <a href="javascript:void(0);">
	               <img alt="客户信息" style="vertical-align:middle;" src="${pageContext.request.contextPath}/menuIcons/department.png" 
	               onclick="showEwlpCustInfo('${requestScope['contract_info.custid'] }')"
	               /></a>
	              </td>
	         </tr>
	         ...
	         <tr class="tr-project-info tr-odd">
	             ...
	             <td class="td-content">
	             <input name="contract_info.projtype"   class="mini-combobox" textField="name"  required="true"
		                  	   valueField="value"  
							   dataField="datas"
							   allowInput="false" 
				 ...
				 />
				 <font class="required-tag">*</font>
				 <input id="rawValue_contract_info.projtype" name="rawValue_contract_info.projtype" value="${requestScope['rawValue_contract_info.projtype']}" class="mini-textbox" style="display:none"/>
	             </td>
	             
	             <td class="td-content-title">项目规模：</td>
	             <td class="td-content">
	             <input name="contract_info.projscale" class="mini-combobox" textField="name"  required="true"
		                  	   valueField="value"  
							   dataField="datas"
							   allowInput="false" 
	          ...
	          <tr class="tr-project-info tr-even">  
	             ...
	             <td class="td-content">
	             <input name="contract_info.projsource" class="mini-combobox" textField="name"  required="true"
		                  	   valueField="value"  
							   dataField="datas"
							   allowInput="false" 
	             ...
	             <td class="td-content">
	             <input name="contract_info.industrytype" class="mini-combobox" textField="name"  required="true"
		                  	   valueField="value"  
							   dataField="datas"
							   allowInput="false" 
	          ...
	          <tr class="tr-project-info tr-odd">   
	             ...
	             <td class="td-content">
	             <input name="contract_info.leastype" class="mini-combobox" textField="name"  required="true"
		                  	   valueField="value"  
							   dataField="datas"
							   allowInput="false" 
	             ...
	             <td class="td-content">
	             <input name="contract_info.leasform" class="mini-combobox" textField="name"  required="true"
		                  	   valueField="value"  
							   dataField="datas"
							   allowInput="false" 
							   data-options="{_params:{pid:'leas_form'}}" 
							   onbeforeshowpopup="onbeforeshowpopup"
							   value="${requestScope['contract_info.leasform'] }" 
							   text="${requestScope['rawValue_contract_info.leasform'] }" 
							   onvaluechanged="comboboxChanged"
				 />
				 <font class="required-tag">*</font>
				 <input id="rawValue_contract_info.leasform" name="rawValue_contract_info.leasform" value="${requestScope['rawValue_contract_info.leasform']}" class="mini-textbox" style="display:none"/>
	             </td>
	         </tr>  
	         ...
	         <tr class="tr-project-info tr-even">   
	             ...
	             <td class="td-content">
	             <input name="contract_info.projdept" class="mini-combobox" textField="name"  required="true"
		                  	   valueField="id"  
							   dataField="datas"
							   allowInput="false" 
							   data-options="{_xmlFileName:'/eleasing/workflow/public/department_combox.xml',_params:{pid:'leas_form',deptname:'子公司项目部'}}" 
							   onbeforeshowpopup="onbeforeshowpopup"
							   value="${requestScope['contract_info.projdept'] }" 
							   text="${requestScope['rawValue_contract_info.projdept'] }" 
							   onvaluechanged="comboboxChanged"
				 />
				 <font class="required-tag">*</font>
				 <input id="rawValue_contract_info.projdept" name="rawValue_contract_info.projdept" value="${requestScope['rawValue_contract_info.projdept']}" class="mini-textbox" style="display:none"/>
	             </td>
	             <td class="td-content-title">经办人(录入人员)：</td>
	             <td class="td-content">
	             <input name="contract_info.projregistrar" class="mini-combobox" textField="name"  required="true"
		                  	   valueField="id"  
							   dataField="datas"
							   allowInput="false" 
							   data-options="{_xmlFileName:'/eleasing/workflow/public/creator_combox.xml',_params:{deptname:'子公司项目部'}}" 
							   onbeforeshowpopup="onbeforeshowpopup"
							   value="${requestScope['contract_info.projregistrar'] }" 
							   text="${requestScope['rawValue_contract_info.projregistrar'] }" 
							   onvaluechanged="comboboxChanged"
				 />
				 <font class="required-tag">*</font>
				 <input id="rawValue_contract_info.projregistrar" name="rawValue_contract_info.projregistrar" value="${requestScope['rawValue_contract_info.projregistrar']}" class="mini-textbox" style="display:none"/>
	             </td>
	         
	         </tr>
	          <tr class="tr-project-info tr-odd">   
	             <td class="td-content-title">项目经理：</td><td class="td-content">
	             <input name="contract_info.projmanage" class="mini-combobox" textField="name"  required="true"
		                  	   valueField="id"  
							   dataField="datas"
							   allowInput="false" 
							   data-options="{_xmlFileName:'/eleasing/workflow/public/creator_combox.xml',_params:{deptname:'子公司项目部'}}" 
				 ...
				 />
				 <font class="required-tag">*</font>
				 <input id="rawValue_contract_info.projmanage" name="rawValue_contract_info.projmanage" value="${requestScope['rawValue_contract_info.projmanage']}" class="mini-textbox" style="display:none"/>
				 </td>
				 <td class="td-content-title">项目协办：</td><td class="td-content">
	             <input name="contract_info.projassist" class="mini-combobox" textField="name"  required="true"
		                  	   valueField="id"  
							   dataField="datas"
							   allowInput="false" 
							   data-options="{_xmlFileName:'/eleasing/workflow/public/creator_combox.xml',_params:{deptname:'子公司项目部'}}" 
				 ...
				 />
				 <font class="required-tag">*</font>
				 <input id="rawValue_contract_info.projassist" name="rawValue_contract_info.projassist" value="${requestScope['rawValue_contract_info.projassist']}" class="mini-textbox" style="display:none"/>
	             </td>
	          </tr>
	</table>
	</div>
