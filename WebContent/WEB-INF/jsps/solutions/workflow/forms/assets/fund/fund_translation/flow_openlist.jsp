	 ...
	 var table = new tracywindyOperationTable({
      ...
      tools:[{
		 ...
		 handler : function(table) {
				...
				attachmentParams = attachmentParams + "&ebank_id=" +projIDValue[0].id +"&cur_depid="+cur_depid+"&dealer="+projIDValue[0].custname;
				startProcess("经销商租金回笼-1",attachmentParams);
			},
			iconCls :'icon-update'
          }],
          columns:[
                   ...
                   {header:'custdealerid',name:'custdealerid',hidden:true},
		            ...
		            {header:'流水号',name:'sn',queryConfig:{isNewLine:true}},
