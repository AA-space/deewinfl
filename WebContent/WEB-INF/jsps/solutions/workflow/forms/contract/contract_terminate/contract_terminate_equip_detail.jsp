...
jQuery(function(){
	//dictYesOrNoByCode('id_isAffiliated','isAffiliated',1,'','','require="true" label="是否挂靠"');
	    ...
	    columns:[
	       ...
	       {name:'equipclassname', header:'车辆分类',type:'combobox',readOnly:true ,hiddenName:'equipclass',
			    config:{
		...
		/*    {name:'equiptypename', header:'车辆类别',type:'combobox',readOnly:true ,hiddenName:'equiptype',
			    config:{
		   ...
		   {name:'modelname', header:'规格型号',type:'combobox',readOnly:true ,hiddenName:'model',
			    config:{
				       width:165,
		   ...
		   {name:'equipcontractnum',  header:'车辆合同小号',readOnly:true,otherAttributes:'maxB="20"',otherAttributes:'id="id_equipcontractnum"'},
		   {name:'chassisnum',  header:'车架号',readOnly:true,otherAttributes:'maxB="100"',otherAttributes:'id="id_chassisnum"' },
		   {header:'是否提前终止',name:'isadvancestopname',nullable:false,type:'combobox',hiddenName:'isadvancestop' 
	            ,config:{
				width:165,
				//isNewLine:true,
				//colSpan:3, 
	       ...
	       {name:'isadvancestop', header:'是否提前终止id',hidden:true},
		   ...
		   {name:'saleprice',  header:'销售价',type:'double',readOnly:true ,otherAttributes:'id="id_saleprice" onkeyup="AdjustTotal()" onkeyup="AdjustMoney()"'},
		   {name:'purchaseprice',  header:'采购价',type:'double',readOnly:true ,otherAttributes:'id="id_purchaseprice" onkeyup="AdjustMoney()"'}, 
		   {name:'differential_swap',  header:'差额[销售价-采购价]',type:'double',readOnly:true ,otherAttributes:'id="id_differential_swap"',readOnly:true,width:160},
		   ...
		   {name:'leasingmoney',  header:'其他融资额',readOnly:true,hidden:true,type:'double',defaultValue:'0',otherAttributes:'id="id_leasingmoney" onkeyup="AdjustTotal()"'},
	       {name:'devicetypename',  header:'设备类型',readOnly:true,type:'combobox',defaultRawValue:'' ,hiddenName:'devicetype',
			    config:{
			       width:165,
	       ...
	       {name:'nowtotal',  header:'总计',readOnly:true ,otherAttributes:'id="id_nowtotal"',readOnly:true,width:130,type:'double'},
	       {name:'manufacturername',readOnly:true,  header:'制造商',type:'combobox' ,hiddenName:'manufacturer',
			    config:{
			       width:165,
  			...
  			{header:'是否挂靠',readOnly:true,name:'isaffiliatedname',type:'combobox',hiddenName:'isaffiliated',otherAttributes:'id="id_isaffiliated"',
	            config:{
  				width:165,
				isNewLine:true,
				isForceModify:true,
           ...
           {name:'isaffiliated', header:'是否挂靠id',hidden:true},
  		   {name:'affiliatedinfo',readOnly:true, header:"挂靠单位及法人信息",type:'textarea',otherAttributes:'maxB="2000" id="id_affiliatedinfo"'},
  		   {name:'manufacturer', header:'制造商id',readOnly:true,hidden:true},    
	       {name:'equipdeliveryplace',readOnly:true,  header:'交付地点' ,otherAttributes:'maxB="2000"'},
	       {name:'equipdeliverydate',readOnly:true,  header:'预计交付时间',type:'date' },
