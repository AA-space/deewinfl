...
function openWindow(){
	...
	if (!cust_id) {
		...
		return false;
	       ...
	       startProcess("多次合同起租流程-1",attachmentParams);
	}
}
...
<body>
	<div id="id_menuDetailInfoForm" class="easyui-window" closed="true" modal="true" title="多次合同起租" style="display:none;width:600px;height:250px;text-align:center;">
	        <center>
