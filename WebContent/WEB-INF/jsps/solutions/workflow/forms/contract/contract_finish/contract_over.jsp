<%@ page language="java" contentType="text/html; charset=UTF-8"    pageEncoding="UTF-8"%>
         ...
         <tr>
          ...
          <tr class="tr-contractect-info tr-even">   
             ...
             <td class="td-content-title"><input style="margin-top:2px;margin-bottom:2px;" id="btn_rent_cal"  class="btn btn-primary" type="button"  value="结算IRR" onclick="IRR_Calc('${requestScope['contract_info.id'] }');"/></td> 
         </tr>
          <!--<tr class="tr-contractect-info tr-even"> 
