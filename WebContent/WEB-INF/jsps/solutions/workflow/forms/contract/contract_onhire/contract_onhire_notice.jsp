<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    jQuery(function(){
	    ...
	    otherTools:[{
	     	 html : '<font color="blue">生成起租通知函</font>',
 ...
 <table cellspacing="0" cellpadding="0">
        <tr>
             <td class="x-panel-table-div-title" colspan=4><div class="toggle-icon-expanded" title="折叠" toggleClass="tr-proj-credit-report"></div>起租通知函</td>
          </tr>
