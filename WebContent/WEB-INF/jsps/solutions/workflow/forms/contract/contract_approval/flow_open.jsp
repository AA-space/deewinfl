...
combo_proj = new tracywindyComboBox({
    ...
    xmlFileName:'\\eleasing\\workflow\\contract\\contractApproval.xml',
    loadMode:'ajax',
    readOnly:false,
    isAjaxLenovo:true,
    dropListHeight:300,
 ...
 /* var cust_id = getTracywindyObject('id_combo_cust').getValue();
	...
	if (!cust_id) {
		...
		return false;
		   ...
		   var attachmentParams="cust_id="+cust_id+"&proj_id="+proj_id;
...
<body>
	<div id="id_menuDetailInfoForm" class="easyui-window" closed="true" modal="true" title="合同审批" style="display:none;width:600px;height:250px;text-align:center;">
	        <center>
