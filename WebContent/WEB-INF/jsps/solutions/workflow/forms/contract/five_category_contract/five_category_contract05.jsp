	...
	<tr>
		<td>
			<div id='id_project_info_tabs_content' style="">
				...
				<div title="风险五级">
					<span class="print-tabs-title-content">风险五级</span>
					<div id="id_table_leasing_proj_condition_container" style="overflow: hidden;">
				    	<!-- 插入业务五级 --> <jsp:include page="risk_five.jsp"></jsp:include>
				    </div>
				</div>
				<div title="风控五级">
					<span class="print-tabs-title-content">风控五级</span>
					<div id="id_table_leasing_proj_condition_container" style="overflow: hidden;">
					<script language="javascript">jQuery(function() {isViewHistoryTask = isCompletedTask;});</script>
				    	<!-- 插入业务五级 --> <jsp:include page="sale_five.jsp"></jsp:include>
				    	<script language="javascript">jQuery("#five_category_content_sale input[name='five_category.contractfivedate_sale']").attr("isForceModify","true");</script>
...
<script>
	function formPageReadOnlyCallBack(){
	    if(!isCompletedTask){
		   formJSPInputHideOrShow("five_category_content_sale","",1);
	    }
	}
	//初始化调用
	jQuery(function() {
