		...
		<td>
			<div id='id_project_info_tabs_content' style="">
				...
				<div title="资产五级">
					...
					<script language="javascript">jQuery("#five_category_content_assets input[name='five_category.contractfive_dateassets']").attr("isForceModify","true");</script>
...
<script>
	function formPageReadOnlyCallBack(){
	    if(!isCompletedTask){
		   formJSPInputHideOrShow("five_category_content_assets","",1);
	    }
	}
	//初始化调用
	jQuery(function() {
