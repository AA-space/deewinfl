...
function openWindow(){
	...
	if (!cust_id) {
		...
		return false;
	       ...
	       startProcess("客户巡访流程-1",attachmentParams);
	}
}
...
<body>
	<div id="id_menuDetailInfoForm" class="easyui-window" closed="true" modal="true" title="客户巡访" style="display:none;width:600px;height:250px;text-align:center;">
	        <center>
