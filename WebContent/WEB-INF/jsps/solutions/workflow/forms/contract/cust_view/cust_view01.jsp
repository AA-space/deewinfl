...
<script type="text/javascript">
	...
	function formPageReadOnlyCallBack(){
	    if(!isCompletedTask){
		   formJSPInputHideOrShow("id_table_leasing_contract_sign_container","",1);
	    }
	 }
					...
					<div id="id_table_leasing_contract_sign_container"	style="overflow: hidden;">
						<table cellspacing="0" cellpadding="0" style="width: 98%; margin-top: 20px;" >
							 <tr  class="tr-contractect-other-info tr-even">
							    ...
							    <td class="td-content-title">巡视时间：</td><td class="td-content"><input name="cust_view.viewTime" class="Wdate td-content-input td-content-readonly"  
                                      type="text" dataType="Date" value="${requestScope['cust_view.viewTime'] }"  onClick="WdatePicker(this,{readOnly:true})" readOnly require="true" label="巡视时间" /><font class="required-content">*</font></td>
							    </tr>
							<tr  class="tr-contractect-other-info tr-even">
