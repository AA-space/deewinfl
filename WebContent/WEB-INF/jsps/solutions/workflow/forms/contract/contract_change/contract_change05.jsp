...
<input type="hidden" id="id_contract_doc_send_info_str" name="json_contract_doc_send_info_str" value='${empty json_contract_doc_send_info_str ? "[]" : json_contract_doc_send_info_str }'></input>
		...
		<div id='id_contract_info_tabs_content' style="">
			...
			<div title="合同登记">
				...
				<div id="id_table_leasing_contract_doc_send_info"	style="overflow: hidden;">
					<jsp:include page="../contract_approval/contract_doc_send_info.jsp"></jsp:include>
					<script type="text/javascript">
					    jQuery(function() {
...
<jsp:include page="../contract_approval/contract_doc_ems_info.jsp"></jsp:include><%--前提条件 --%>
<script>

function fillHiddenVal() {
	var contractEquip = getTracywindyObject('table_id_table_leasing_contract_doc_send_info');//租赁物件
	jQuery('#id_contract_doc_send_info_str').val(JsonUtil.encode(contractEquip.getRowsJsonData()));
}
</script>