   	 ...
   	 var table = new tracywindyOperationTable({
         ...
         tools:[{
 			...
 			handler : function(table) {
                ...
                var param ={};
                param.contract_id = projIDValue[0]["id"];
                var tourl = getRootPath()+"/leasing/checkContractChargeInfo.action";
                 
                $.ajax({
        			type : "post",
        			url : getRootPath()+"/leasing/checkContractChargeInfo.action",
        			cache : false,
        			async : false,
        			data : param,
        			success : function(rs) 
        			{
        			   ...
        			   svote=svote.replace(/(^\s+)|(\s+$)/g, ""); 
						...
						var attachmentParams = "contract_id=" + projIDValue[0]["id"]+"&cust_id="+projIDValue[0]["custid"]+"&proj_id="+projIDValue[0]["pid"];
         ...
         columns:[
		            ...
		            {header:'项目名称',name:'projname',width:400,queryConfig:{isNewLine:true}},
