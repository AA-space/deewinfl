...
<script type="text/javascript">
	...
	function formPageReadOnlyCallBack(){
	       ...
	       if(!isCompletedTask){
	          ...
	          formJSPInputHideOrShow("review_report","proj_other_info.singletime,proj_other_info.singleincome,proj_other_info.singlefee",1);
	          formJSPInputHideOrShow("credit_report_list","",1);
	...
	function workflowSubmitCallBack()//返回true提交，返回false不提交 ，该回调函数可与用表单字段验证
	{
		...
		//检查租赁物件
		if(!checkTracywindyTableData("table_id_table_leasing_proj_equip_container","租赁物件")){return false;}
		//担保信息
		if(!checkTracywindyTableData("table_id_table_leasing_proj_guarantee_method_container","担保信息")){return false;}
		//租金计划
...
<!--多行控件  -->
<input type="hidden" id="id_json_proj_equip_str" 
	   name="json_proj_equip_str"
 	   value='${empty json_proj_equip_str ? "[]" : json_proj_equip_str }'></input>
<input type="hidden" id="id_json_proj_guarantee_method_str" 
	   name="json_proj_guarantee_method_str" 
	   value='${empty json_proj_guarantee_method_str ? "[]" : json_proj_guarantee_method_str }'></input>
<!--结束多行控件  -->
   ...
   <table class="fillTable" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td colspan=4><!-- 插入项目基本信息 --> <jsp:include
			page="../apply/nocar_base_info.jsp"></jsp:include></td>
	</tr>
	<tr>
	<td colspan="4">
	 <!-- 插入法人客户信息 --> <jsp:include page="../apply/nocar_apply_custom_info.jsp"></jsp:include>
	</td>
	</tr>
	<tr>
		<td colspan=4> 
		...
		<jsp:include page="../review/nocar_review_report_info.jsp"></jsp:include>
		<script language="javascript">
	...
	<tr>
		<td colspan=4><!-- 插入项目信审其它基本信息 --> <jsp:include
			page="../../project/proj_credit/proj_credit_other_info.jsp"></jsp:include></td>
	</tr>
	<tr>
		...
		<script language="javascript">
		 ...
		 <jsp:include  page="../../project/proj_credit/proj_credit_result_info.jsp"></jsp:include>
		     <script language="javascript">
			    jQuery(function() {isViewHistoryTask = true;});
            </script>
        </td>
		...
		<td colspan=4 class="td-tabs-container" style="text-indent: 0px;">
			...
			<div id='id_project_info_tabs_content' style="">
					...
					<div id="id_table_leasing_proj_change_info_container"
						style="overflow: hidden;"><jsp:include page="../../project/proj_reconsider/proj_review_info.jsp"></jsp:include></div>
					</div>
					<div title="租赁物件">
					...
					<div title="租金发票类型">
						...
						<div id="id_table_leasing_proj_rent_type_container"
							style="height: 350px;"><jsp:include page="../nocar_public/rent_invoice.jsp"></jsp:include>
						</div>
					</div>
			</div>
		</td>
