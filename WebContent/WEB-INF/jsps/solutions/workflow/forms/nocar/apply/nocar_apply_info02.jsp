...
<script type="text/javascript">
	...
	function formPageReadOnlyCallBack(){
		formJSPInputHideOrShow("proj_invoice_type_table","",1);
	}
</script>
<!--多行控件  -->
   ...
   <table class="fillTable" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td colspan=4><!-- 插入项目基本信息 --> <jsp:include
			page="nocar_base_info.jsp"></jsp:include></td>
	</tr>
	<tr>
	<td colspan="4">
	...
	<tr>
		<td colspan=4><!-- 插入项目其它基本信息 --> <jsp:include
			page="nocar_apply_other_info.jsp"></jsp:include></td>
	</tr>
	<!--<tr>
		...
		<td colspan=4 class="td-tabs-container" style="text-indent: 0px;">
			...
			<div id='id_project_info_tabs_content' style="">
					...
					<div title="租金发票类型"><span class="print-tabs-title-content">租金发票类型</span><div id="id_table_leasing_proj_rent_type_container"  style="height:350px;">
				    	...
				    	<jsp:include page="../../project/proj_approval/proj_invoice.jsp"></jsp:include>
				    	<script language="javascript">
