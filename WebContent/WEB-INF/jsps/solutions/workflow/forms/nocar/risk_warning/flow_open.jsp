...
function openWindow(){
    ...
    if (!cust_id) {
	    ...
	    return false;
    	 ...
    	 startProcess("风险预警流程-1",attachmentParams);//注明启动那个流程
    }
}
...
<body>
	<div id="id_menuDetailInfoForm" class="easyui-window" closed="true" modal="true" title="风险预警流程" style="display:none;width:600px;height:250px;text-align:center;">
	        <center>
