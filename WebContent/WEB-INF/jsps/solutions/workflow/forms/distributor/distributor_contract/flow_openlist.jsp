...
jQuery(function(){
	...
	var table = new tracywindyOperationTable ({
				...
				tools : [ {
				    ...
				    var attachmentParams="&cust_id="+projIDValue[0].cust_id+"&approvalnum="+projIDValue[0].approvalnum+"&approvaldata="+projIDValue[0].approvaldata+"&dealerid="+projIDValue[0].dealerid;
			...
			params:{
		 draft:'1',dealertstatus2:'dealerApprovalstatus4'
