	...
	if (!cust_id) {
		...
		return false;
		  ...
		  // alert(attachmentParams);
	       startProcess("经销商合同管理-1",attachmentParams);
        }
	}
</script>
</head>
<body>
	<div id="id_menuDetailInfoForm" class="easyui-window" closed="true" modal="true" title="经销商合同管理" style="display:none;width:600px;height:250px;text-align:center;">
	        <center>
