...
jQuery(function(){
	    ...
	    columns:[
			       ...
			       {name:'factmoney',  header:'金额',readOnly:true,nullable:false,type:'double',otherAttributes:'id="re_factmoney" onkeyup="comptuerPartAdjustMoney()"'},
			       {name:'factdate',  header:'付款时间',type:'date',defaultValue:"${requestScope['fund_ebank_data.factdate']}"},
			       {name:'accountbank',  header:'银行',defaultValue:"${requestScope['fund_ebank_data.ownbank']}"},
			       {name:'account',  header:'银行账户',defaultValue:"${requestScope['fund_ebank_data.ownaccount']}"},
			       {name:'accnumber',  header:'银行帐号',nullable:false,defaultValue:"${requestScope['fund_ebank_data.ownaccnumber']}"},
			       {name:'factobject',  header:'收款客户',nullable:false,readOnly:true,defaultValue:"${requestScope['cust_info.custname']}"},
			       {name:'clientbank',  header:'客户银行',defaultValue:"${requestScope['fund_ebank_data.clientbank']}"},
			       {name:'clientaccount',  header:'客户帐户',defaultValue:"${requestScope['fund_ebank_data.clientaccount']}"},
			       {name:'clientaccnumber',  header:'客户帐号',nullable:false,defaultValue:"${requestScope['fund_ebank_data.clientaccnumber']}"},
