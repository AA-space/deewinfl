...
jQuery(function(){
	...
	var table = new tracywindyOperationTable ({
				...
				emptyChar : '-',
				checkType : 'radio',
				xmlFileName : 'eleasing/workflow/distributor/DistributorFlowSelectList.xml',
				columns : [
						{
							header : '经销商名称',
							name : 'custname',type : 'text',queryConfig : {}
						},
						{
							header : '合作经销商编号',
							name : 'contractnum'
			...
			params:{
		//  draft:'1',dealerstatus:'dealer_symbiosis2',dealercreditstatus:'dealerApprovalstatus3'
