...
<script type="text/javascript">
   ...
   isViewHistoryTask = true;
	...
	function workflowSubmitCallBack()//返回true提交，返回false不提交 ，该回调函数可与用表单字段验证
	{
		fillHiddenVal();
		//检查租赁物明细
		if(!checkTracywindyTableData("table_id_table_receivercharge_container","本次退款信息")){return false;}  
		//var submitProcessedForm = document.getElementById("id_submitProcessedForm");
...
<div class="fillTableContainer">
   ...
   <tr>
	...
	<tr>
		...
		<div class="toggle-icon-expanded" title="折叠" toggleClass="tr-project-info"></div>历史保证金收款明细</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="x-panel-table-div-title" >
		<div class="toggle-icon-expanded" title="折叠" toggleClass="tr-project-info"></div>保证金退款明细</td>
	</tr>
	<tr>
	<td class="td-tabs-container" style="text-indent: 0px;">
