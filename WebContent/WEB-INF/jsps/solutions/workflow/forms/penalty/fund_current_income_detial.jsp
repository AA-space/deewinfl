<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	var table_fund_rent_inComes = new tracywindyMultiTable({
	    ...
	    columns:[
	       ...
	       {name:'hirelist',  header:'回笼期项',readOnly:true,hidden:true}, //,hidden:true
	       ...
	       {name:'penaltyadjust',  header:'罚息调整(减免值)', nullable:false,type:'double', readOnly:false,otherAttributes:'id="re_penaltyadjust" onkeyup="comptuerCurMoney()"'},
