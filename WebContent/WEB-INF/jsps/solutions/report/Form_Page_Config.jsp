    	...
    	<div title="<s:message code='report.config.form.page.basic' text='基本' />" class="form_tab">
    		<table style="width:90%">
				...
				<tr id="tr_layout_width" style="display:none">
					...
					<td class="input_value"><input type="text"  name="page_layout_width" id="page_layout_width" value="600"/><span class="content-required">px</span></td>
				</tr>
				<tr id="tr_layout_height" style="display:none">
					<td class="input_label_desc">页面高度:</td>
					<td class="input_value"><input type="text"  name="page_layout_height" id="page_layout_height" value="300"/><span class="content-required">px</span></td>
				</tr>			
			</table>
    	</div>
    </div>
