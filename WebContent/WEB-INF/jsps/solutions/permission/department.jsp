...
<script type="text/javascript">
    ...
    function loadFormData(){
        ...
        $("#"+formId+" input[name='name']").val(currentMenuNode.text);
...
<body>
	...
	<div id="id_detailInfoWindowContianer"  closed="true" modal="true" title="部门信息管理" style="display:none;width:400px;padding-top:20px;height:280px;">
	        <center>
