	...
	jQuery(function(){
		var mynotice = new tracywindyOperationTable({
	         ...
	         tools:[{
	        	  ...
	        	  isHtml:true,
	     	      html:'请输入登陆编码：<input type="text" style="margin-right:3px;border:1px solid #DDD;" id="id_queryWorkflowsTableInput" value="'+unescape(decodeURIComponent("${param.queryText}"))+'" />'
	         }],
	         columns:[
