...
<script type="text/javascript"> 
	...
	jQuery(function(){
   	 var table = new tracywindyOperationTable({
         ...
         id:'id_table',
         xmlFileName:'/eleasing/jsp/project_manage/proj_credit_cancel_list.xml',
         loadMode:'ajax',
         params:{
         ...
         tools:[{
 			...
 			handler : function(table) {
				...
				var url = getRootPath()+"/leasing/updateProjCancel.action";
 				param = {};
         ...
         columns:[
		            ...
		            {header:'信审通过时间',name:'proj_credit_pass_time',type:'date',queryConfig:{isNewLine:true}},
         ]
   	 });
   });
