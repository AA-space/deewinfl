...
<permission:action  code="ebank_enabled">
	ebank_enabled=true;
</permission:action>
//########操作权限##############
jQuery(function(){
...
var importcolumn= [
    ...
    function delFundEbank(table){
    	...
    	if(ids &&  confirm("确定要删除数据吗？")){
	    	ajaxRequest({
			     url:getRootPath()+"/leasing/acl/removefundebank.acl",
			     method:'POST',
			     success:function(res){
			        alert("操作成功");
			        var table = getTracywindyObject("id_table");
    ...
    function enableFundEbank(table){
    	var plandata = table.getCheckedRowDatas();
    	if(plandata.length == 0 ){
    		alert("请选择需要启用的项目");
    		return;
	...
	jQuery(function(){
    	...
    	,
   	  loadFormDataCallBack:function(table,$form,rowIndex){
    		...
    		document.getElementById("id_fund_ebank_status").value = str;
    			//3.设置修改前的是否有效
		        ...
		        <form id="id_detailInfoForm">
			        <table style="width:90%" class="fillTable">
			            ...
			            <td class="td-content-title" >流水号:  </td>  
			            	...
			            	<td  class="td-content">
			            	 <!-- <input name="enabled" ></input> -->
			            	  <input id="id_fund_ebank_status"  require="true"  class="td-content-input td-content-readonly" label="状态"  readOnly type="text" />
			            ...
			            <tr  class="tr-other-info tr-even">
			            	...
			            	<td class="td-content">
			            		<input name="clientname" class="td-content-input"  label="付款人"  type="text" />
			            	</td>
			            </tr>
			            <tr  class="tr-other-info tr-odd">
			            	...
			            	<td class="td-content">
			            	<input name="clientbank" class="td-content-input"   label="对方银行"  type="text" />
			            	</td>
			            ...
			            <tr  class="tr-other-info tr-even">
			            	...
			            	<td class="td-content">
			            	   <input name="clientaccount"  class="td-content-input"   label="对方账户" type="text" />
			            	</td>
			            </tr>
			             <tr  class="tr-other-info tr-odd">
			            	...
			            	<td class="td-content">
			                 	<input name="clientaccnumber"  class="td-content-input"  label="对方账号"  type="text" />
			            	</td>
			            </tr>
			            <tr  class="tr-other-info tr-even">
			            	...
			            	<td class="td-content">
			            		<input name="factmoney" id="id_factmoney" require="true" class="td-content-input"  label="到账金额" dataType="Money"  type="text" /><font class="required-content">*</font>
			            		</td>
			            </tr>
			            <tr  class="tr-other-info tr-odd">
			            ...
			            <tr  class="tr-other-info tr-even">
			               <td class="td-content-title">到账时间:  </td>  
			            	<td class="td-content">
			                 <input name="factdate" class="td-content-input "  type="text" value="${requestScope['factdate'] }"  require="true" label="到账时间" /><font class="required-content">*</font>
          	            	</td>
