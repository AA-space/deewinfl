	...
	jQuery(function(){
    	...
    	,
   	  loadFormDataCallBack:function(table,$form,rowIndex){
     		 ...
     		 if(rowData["kehuid"]){
    	        select_contract.setValue(rowData["kehuid"]);
         ...
         columns:[
			        ...
			        {header:'客户',name:'kehu',queryConfig:{}},    
		            ...
		            {header:'备注1',name:'summary',queryConfig:{}},
