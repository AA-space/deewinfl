...
var tools=[ {
    	...
    	var operType = "生成";
			...
			var operAction = "removeRentIncomeReceipt";
	 		var checkedRowDatas = table.getCheckedRowDatas();
			var currentLoadMask = null;
	        var params = {};
	        var tempIdArr = [];
...
tools=[ {
    	...
    	var operType = "生成";
			...
			params["typnames"] = tempPIdArr.join(",");
	 		...
	 		for(var i =0;i<checkedRowDatas.length;i++){
				var checkedRawData=checkedRowDatas[i];
				if("确认中"==checkedRawData.status||"已导出"==checkedRawData.status||"已确认"==checkedRawData.status){
...
<script type="text/javascript">
	jQuery(function(){
   	 var table = new tracywindyOperationTable({
		 ...
		 windowTop:20,
   	     border:true,
         title:'租金实收应开票数据提醒清单（收据）',
         tools : tools,

         id:'id_table',
         xmlFileName:'/eleasing/jsp/invoice_manage/rent_invoice/rent_invoice_income_receipt.xml',
         loadMode:'ajax',
         isPage:true,
         isExcel:true,
         pageSize : 20,
         ...
         columns:[
			       ...
			       {name:'plandate',  header:'实收日期',nullable:false,type:"date",isRange:true,queryConfig:{isNewLine:true}},
