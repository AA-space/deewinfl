...
var tools=[ {
    	...
    	var operType = "生成";
			var operTitle = "租金计划应开票提醒清单（每期租金）";
			var operAction = "submitRentPlan";
...
<script type="text/javascript">
	jQuery(function(){
   	 var table = new tracywindyTable({
         ...
         id:'id_table',
         xmlFileName:'/eleasing/jsp/invoice_manage/rent_invoice/rent_invoice_plan.xml',
         loadMode:'ajax',
         isPage:true,
         pageSize : 20,
         isFit:false,
         ...
         columns:[
			       ...
			       {name:'contractnumber',  header:'业务合同编号',nullable:false ,queryConfig:{}},
			       ...
			       {name:'plandate',  header:'应收日期',nullable:false },
			       {name:'taxtype',  header:'发票类型',nullable:false },
			       {name:'rentinvoicetype',  header:'开票方式',nullable:false },
			       {name:'status',  header:'状态',nullable:false,type:'combobox',
			    	   queryConfig:{
			    	   isNewLine:false,
			    	   colSpan:3, 
			    	   loadMode:'local',
