...
public final class mainHis_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t        <td ><input class=\"td-content-input\"  name=\"fund_rent_adjust.assetownership\" id=\"assetOwnerShip\" type=\"text\" value=\"");
      ...
      out.write("\"  dataType=\"Date\"  onclick=\"WdatePicker(this,{readOnly:true})\"  Require=\"true\"  label='资产所有权' onchange=\"arrangeEndDate()\"><font class=\"required-content\">*</font></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t    <tr class=\"tr-even\" >\r\n");
      out.write("\t\t\t       \t<td >已到期租金</td>\r\n");
      out.write("\t\t\t           <td ><input class=\"td-content-input td-content-readonly\"  name=\"fund_rent_adjust.dunrent\" id=\"dunRent\" type=\"text\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope['fund_rent_adjust.dunrent']}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\" readonly></td>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope['fund_rent_adjust.dunpenalty']}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\"  readonly></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t    <tr class=\"tr-odd\">\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope['fund_rent_adjust.corpusoverage']}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\" readonly></td>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope['fund_rent_adjust.agreedpenalty']}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope['fund_rent_adjust.agreedinterest']}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope['fund_rent_adjust.currentcautionmoney']}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\"></input></td>\r\n");
      out.write("\t\t\t\t    <!-- \r\n");
      ...
      out.write("    var params = {contract_id:contractId,end_date:endDate};\r\n");
      out.write("    ajaxRequest({\r\n");
      out.write("    \t method:'POST',\r\n");
      out.write("         url:url,\r\n");
      out.write("         params:params,\r\n");
      ...
      out.write("     \t    \t$(\"input[name='fund_rent_adjust.dunrent']\").val(rs['arrangerentfund']);\r\n");
      out.write("     \t    \t$(\"input[name='fund_rent_adjust.corpusoverage']\").val(rs['noarrangecorpusfund']);\r\n");
      out.write("     \t    \t$(\"input[name='fund_rent_adjust.dunpenalty']\").val(rs['penaltyoverage']);\r\n");
      out.write("     \t    }else{\r\n");
      ...
      out.write("\treturn false;\r\n");
      out.write("}\r\n");
      out.write("function contractClaimTotal(){\r\n");
      out.write("\tvar otherin = $(\"input[name='fund_rent_adjust.otherin']\").val();\r\n");
      out.write("\tvar otherout = $(\"input[name='fund_rent_adjust.otherout']\").val();\r\n");
      out.write("\tvar dunpenalty = $(\"input[name='fund_rent_adjust.dunpenalty']\").val()==\"\" ? \"0\":$(\"input[name='fund_rent_adjust.dunpenalty']\").val();\r\n");
      out.write("\tvar handlingcharge = $(\"input[name='fund_rent_adjust.handlingcharge']\").val()==\"\" ? \"0\":$(\"input[name='fund_rent_adjust.handlingcharge']\").val();\r\n");
      out.write("\tvar agreedpenalty = $(\"input[name='fund_rent_adjust.agreedpenalty']\").val()==\"\" ? \"0\":$(\"input[name='fund_rent_adjust.agreedpenalty']\").val();\r\n");
      out.write("\tif(!isNaN(handlingcharge) && !isNaN(agreedpenalty)){\r\n");
      out.write("\t\tvar contracttotal = parseFloat(otherin) + parseFloat(dunpenalty) + parseFloat(handlingcharge) + parseFloat(agreedpenalty) - parseFloat(otherout);\r\n");
      out.write("\t\t$(\"input[name='fund_rent_adjust.contracttotal']\").val(contracttotal);\r\n");
      out.write("\t}else{\r\n");
