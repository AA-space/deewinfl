...
public final class rent_005finvoice_005fincome_005fconfirm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>租金实收开票确认</title>\r\n");
      out.write("    <!--css sheet-->\r\n");
      out.write("<link href=\"");
      ...
      out.write("var tools=[ {\r\n");
      out.write("\t\thtml : '<font color=\"red\">导出租金实收开票数据</font>',\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t    \tvar url=\"/acl/expTaxRentIncomeInvoice.acl\";\r\n");
      out.write("\t    \tvar fileparames={ids:tempIdArr.join(\",\"),url:url,title:\"租金实收开票\",twoClassify:'rentchargeinvoiceconfirm',returnType:'file',modelname:'rentinvoiceconfirm'};\r\n");
      ...
      out.write("\t\t},\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\t\thtml : '<font color=\"red\">退回开票清单</font>',\r\n");
      out.write("\t\thandler : function(table){\r\n");
      out.write("\t\t\tvar operType = \"退回\";\r\n");
      out.write("\t\t\tvar operTitle = \"租金实收开票清单\";\r\n");
      out.write("\t\t\tvar operAction = \"backRentIncome\";\r\n");
      out.write("\t \t\tvar checkedRowDatas = table.getCheckedRowDatas();\r\n");
      ...
      out.write("         xmlFileName:'/eleasing/jsp/invoice_manage/rent_invoice/rent_invoice_income_confirm.xml',\r\n");
      ...
      out.write("\t\t\t       {header:'期项',name:'rentlist' ,width:50   },\r\n");
      out.write("\t\t\t       {header:'计划日期',name:'plandate',type:'date',isRange:true,queryConfig:{isNewLine:true}},\r\n");
      out.write("\t\t\t       {header:'实收日期',name:'hiredate',type:'date',isRange:true,queryConfig:{isNewLine:true}},\r\n");
      out.write("\t\t\t       {header:'开票金额',name:'taxmoney',type:'double' },\r\n");
      out.write("\t\t\t       {header:'金额类型',name:'renttype' },\r\n");
      out.write("\t\t\t       {name:'taxtype',  header:'发票类型',nullable:false ,type:'combobox',queryConfig:{\r\n");
      out.write("\t\t            \tloadMode:'local',\r\n");
      out.write("\t\t            \tdatas:[\r\n");
      out.write("\t\t            \t{title:'增值税专用发票',name:'invoicetype1'},\r\n");
      out.write("\t\t            \t{title:'增值税普通发票',name:'invoicetype2'},\r\n");
      ...
      out.write("\t\t            \tloadMode:'local',\r\n");
      out.write("\t\t            \tdatas:[\r\n");
      out.write("                        {title:'确认中',name:'1'},\r\n");
      out.write("\t\t            \t{title:'已导出',name:'2'}\r\n");
      out.write("\t\t            \t],\r\n");
      out.write("\t\t            \tdisplayField:'title',\r\n");
      out.write("\t\t            \tvalueField:'name',\r\n");
      out.write("\t\t            \tvalue:''\r\n");
  ...
  private boolean _jspx_meth_permission_005faction_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/invoice_manage/rent_invoice/rent_invoice_income_confirm.jsp(119,0) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_permission_005faction_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/invoice_manage/rent_invoice/rent_invoice_income_confirm.jsp(126,0) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_permission_005faction_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/invoice_manage/rent_invoice/rent_invoice_income_confirm.jsp(211,0) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_permission_005faction_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\tfor(var i =0;i<checkedRowDatas.length;i++){\r\n");
        out.write("\t\tvar checkedRawData=checkedRowDatas[i];\r\n");
        out.write("\t\tif(\"已导出\"==checkedRawData.status){\r\n");
        out.write("\t\t\talert(\"该条\"+operTitle+\"已导出，不允许退回！！！\");\r\n");
        out.write("\t\t\treturn;\r\n");
        out.write("\t\t\t} \r\n");
        out.write("\t}\r\n");
        out.write("\tif(!window.confirm((\"确定\"+operType+\"当前\"+checkedRowDatas.length+\"条记录么？\"))) return;\r\n");
