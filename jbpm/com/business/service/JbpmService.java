...
{
   //消息提醒
  public void   sendMessageNoticeToUser(String workflowDisplayName,ActivityDetail pendingActivityDetail,User u,Map<String,String> modelData,SubmitTypeEnum ste,Object jhi_task) throws Exception;
   //项目总表
   public List<JBPMWorkflowHistoryInfo> getProjSummary(String keyOne,String proj_id) throws Exception;
   public List<JBPMWorkflowHistoryInfo> getDealerSummary(String keyOne) throws Exception;
