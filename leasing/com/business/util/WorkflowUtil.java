...
import com.business.entity.base.SerialDiscardNumber;
import com.business.entity.base.SerialNumber;
...
public class WorkflowUtil {
	...
	public static String getReceiptNoInfoSerialNumber(Map<String,String> paramMap,HibernateTemplate hibernateTemplate,JdbcTemplate jdbcTemplate) throws Exception{
		return WorkflowUtil.getSerialNumber("{year}{month}{maxOrderNumber}",4,null, "收据号", null, hibernateTemplate, jdbcTemplate);
	}
	...
	public static String getProjInfoSerialNumber(Map<String,String> paramMap,HibernateTemplate hibernateTemplate,JdbcTemplate jdbcTemplate) throws Exception{
		return WorkflowUtil.getSerialNumber("DY{year}{maxOrderNumber}",6,null, "项目立项流水号", null, hibernateTemplate, jdbcTemplate);
	}
	//收据流水号
	...
	public static void addDiscardContractInfoSerialNumberForBussiness(String contractNumber,String contract_id, HibernateTemplate hibernateTemplate,JdbcTemplate jdbcTemplate){
		...
		SerialDiscardNumber discardNumber=new SerialDiscardNumber();
	...
	public static String getRentInvoiceSerialNumber(Map<String,String> paramMap,HibernateTemplate hibernateTemplate,JdbcTemplate jdbcTemplate) throws Exception{
		return WorkflowUtil.getSerialNumber("{month}{day}{maxOrderNumber}",7,null, "租金计划应开票流水号", null, hibernateTemplate, jdbcTemplate);
	}
	/***
	...
	protected static synchronized int getMaxOrderNumber(String type,Integer queryYear,HibernateTemplate hibernateTemplate,JdbcTemplate jdbcTemplate) throws Exception
	{
		...
		{
			serialNumber = (SerialNumber)maxOrderNumberList.get(0);
		}
		else
		{
	...
	{
		Assert.notNull(type);
		DetachedCriteria criteria = DetachedCriteria.forClass(SerialDiscardNumber.class);
		if(!StringUtils.isBlank(type))
		{
			criteria.add(Restrictions.eq("type",type));
		}
		...
		SerialDiscardNumber  discardNumber = null;
		List<SerialDiscardNumber> minOrderNumberList = hibernateTemplate.findByCriteria(criteria);
	 ...
	 * @since  1.0.0
	 */
	public static String  checkWorkFlowConflict(BaseService tableService,String workFlowName,String flowunid,String flowkey) throws Exception{
		/**
		 * 流程冲突共三步
