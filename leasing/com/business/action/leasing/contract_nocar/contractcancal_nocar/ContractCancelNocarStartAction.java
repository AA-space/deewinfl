 ...
 * Tenwa
 */
@WorkflowAction(name = "contractCancelNocarStartAction", description = "流程开始动作", workflowName = "合同撤销非车业务")
@Component(value = "contractCancelNocarStartAction")
public class ContractCancelNocarStartAction implements JbpmBaseAction {
	...
	public String delete(HttpServletRequest request, Map<String, String> variablesMap,JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		...
		contractInfo.setContractStatus(0);//取消在流程中状态
