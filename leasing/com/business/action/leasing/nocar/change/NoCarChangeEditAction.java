 ...
 * Tenwa
 */
@WorkflowAction(name = "noCarChangeEditAction", description = "流程修改动作", workflowName = "设备变更流程")
@Component(value = "noCarChangeEditAction")
public class NoCarChangeEditAction implements JbpmBaseAction{
