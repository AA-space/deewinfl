...
@WorkflowAction(name = "interestRateRollBackEditAction", description = "流程编辑动作", workflowName = "调息回滚流程")
@Component(value = "interestRateRollBackEditAction")
public class InterestRateRollBackEditAction implements JbpmBaseAction {
