 ...
 * @info
 */
@WorkflowAction(name = "planModStartAction", description = "流程开始动作", workflowName = "租金计划修改")
@Component(value = "planModStartAction")
public class PlanModStartAction implements JbpmBaseAction {
	...
	public void start(HttpServletRequest request, Map<String, String> variablesMap, JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		...
		variablesMap.put("fund_rent_adjust.adjusttype", "his_plan_mod");
