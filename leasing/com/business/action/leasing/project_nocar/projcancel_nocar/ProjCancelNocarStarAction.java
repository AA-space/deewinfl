 ...
 * Tenwa
 */
@WorkflowAction(name = "projCancelNocarStarAction", description = "流程开始动作", workflowName = "项目撤销非车业务")
@Component(value = "projCancelNocarStarAction")
public class ProjCancelNocarStarAction implements JbpmBaseAction {
