 ...
 * Tenwa
 */
@WorkflowAction(name = "projReconsideNocarStartAction", description = "流程开始动作", workflowName = "项目复议非车业务")
@Component(value = "projReconsideNocarStartAction")
public class ProjReconsideNocarStartAction implements JbpmBaseAction {
