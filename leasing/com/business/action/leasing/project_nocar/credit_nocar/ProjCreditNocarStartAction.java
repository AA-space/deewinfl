 ...
 * Tenwa
 */
@WorkflowAction(name = "projCreditNocarStartAction", description = "流程开始动作", workflowName = "项目信审非车业务")
@Component(value = "projCreditNocarStartAction")
public class ProjCreditNocarStartAction implements JbpmBaseAction {
