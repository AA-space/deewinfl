 ...
 * Tenwa
 */
@WorkflowAction(name = "projCancelStartAction", description = "流程开始动作", workflowName = "项目立项撤销流程")
...
public class ProjCancelStartAction implements JbpmBaseAction {
	...
	public void start(HttpServletRequest request, Map<String, String> variablesMap,JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		Logger logger=Logger.getLogger(ProjCancelStartAction.class.getName());
...
//		variablesMap.put("proj_info.industrytype", custInfo.getCustClass().getCode().equals("CUST_INFO_COMPANY")?custInfo.getCustInfoCompany().getCustKind().getCode():custInfo.getCustInfoPerson().getCustKind().getCode());
		...
		if (!projInfo.getProjGuaranteeMethods().isEmpty()) {// 担保单位
			...
			//System.out.println(variablesMap.get("json_proj_guarantee_method_str"));
		}
