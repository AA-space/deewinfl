...
@WorkflowAction(name = "projCancelEditAction", description = "流程修改动作", workflowName = "项目立项撤销流程")
@Component(value = "projCancelEditAction")
public class ProjCancelEditAction implements JbpmBaseAction {
