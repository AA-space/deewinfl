 ...
 * Tenwa
 */
@WorkflowAction(name = "distributorMortgageContractStartAction", description = "流程开始动作", workflowName = "经销商抵押合同事宜办理流程")
@Component(value = "distributorMortgageContractStartAction")
public class DistributorMortgageContractStartAction implements JbpmBaseAction {
