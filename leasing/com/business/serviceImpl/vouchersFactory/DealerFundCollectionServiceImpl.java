...
@Service(value = "dealerFundCollectionService")
public class DealerFundCollectionServiceImpl implements DealerFundCollectionService {
	...
	public void createVoucher(ContractInfo cinfo,BigDecimal sum) throws Exception {
		...
		String voucherAbstract_01 = "核销‘"+cinfo.getCustId().getCustName()+"’-首付款‘"+Tools.formatNumberDoubleTwo( String.valueOf(originalAmount) )+"’";//摘要
		...
		String voucherAbstract_02 = "核销‘"+cinfo.getCustId().getCustName()+"’-首付款‘"+Tools.formatNumberDoubleTwo( String.valueOf(originalAmount) )+"’";//摘要
