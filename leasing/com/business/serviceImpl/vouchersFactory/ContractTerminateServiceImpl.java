...
public class ContractTerminateServiceImpl implements ContractTerminateService {
	...
	@Override
	public void createVoucherPrepayment(ContractInfo cinfo,Map<String,Object> map) throws Exception {
		...
		//流程名称
		BigDecimal corpusover  = (BigDecimal)map.get("corpusoverage");
		BigDecimal interestover  = (BigDecimal)map.get("interestover");
		BigDecimal rentover  = (BigDecimal)map.get("rentover");
		String voucherAbstract = "核销"+cinfo.getCustId().getCustName()+cinfo.getContractNumber()+"提前还款";//摘要
		/** 本凭证-公用字段-结束*/
		...
		body_01.setOriginalAmount(corpusover);      //原币金额 
		...
		body_02.setOriginalAmount(interestover);               //原币金额 
		...
		/************************************** 凭证体3-分割线-开始 ********************************************************/
		/**贷 3 :建立凭证体3-开始 */
		VoucherassStactsConfig config_03 = this.baseService.findEntityByID(VoucherassStactsConfig.class,"222"); 
		...
		body_03.setOriginalAmount(rentover); //原币金额 
