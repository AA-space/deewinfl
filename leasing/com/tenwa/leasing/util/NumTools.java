...
public class NumTools {
	...
	/**
	 * 
	 * TODO (从第startList开始求和corpus的值)
	 * @param corpus
	 * @param startList 开始求和起点,从1开始
	 * @return
	 */
	public static String getSumCorpusOverage(List corpus,int startList){
	...
	public static String formatNumberDouble(double numstr)   //数字格式化，X,XXX,XXX.XX
	{
		try
		{
