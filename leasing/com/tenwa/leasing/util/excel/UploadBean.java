...
public class UploadBean {
	  public UploadBean()
	     ...
	     * 
	     * TODO (设置允许上传文件类型)
	     * @param canSuffix 允许上传文件类型 格式为 .xx 如: .doc.txt.pdf
	     */
	    ...
	    /**
	     * 
	     * TODO (设置上传输入流调用改方法后将进行文件的上传.)
	     * @param request 页面请求
	     * @throws IOException 抛出IO读取出错异常
	     */
	        ...
	        throws IOException
	    {
	        ...
	        while((a = sis.readLine(b, 0, b.length)) != -1) 
	        {
	            ...
	            if((k = s.indexOf("name=\"")) != -1)
	            {
	                ...
	                //log.debug(fieldName+":"+fieldValue.toString());
	     ...
	     * 
	     * TODO (返回上传文件的内容)
	     * @param fieldName 上传文件名 改名称为上传到服务器之后的名字
